...
/* PAGE-DESIGN-STUDIO-v52.js | render real asset records in Design Studio preview | Generated: 2026-06-01 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v52";
...
var STYLE_ID="syncetc-design-studio-v52-style";
...
function renderAssetsPreviewForDesignStudio(){
  ...
  function val(k){
    return esc(vals["aircraft."+k]||vals["assets."+k]||vals[k]||"");
  }

  return '<section class="aero-fleet-page" data-design-studio-preview-page="assets" data-registry-page="assets">'+
    '<div class="aero-fleet-shell">'+
      '<section class="aero-fleet-hero">'+
        '<div class="aero-fleet-eyebrow">'+val("heroEyebrow")+'</div>'+
        '<h1>'+val("heroTitle")+'</h1>'+
        '<p>'+val("heroIntro")+'</p>'+
      '</section>'+
      '<main class="aero-fleet-main">'+
        '<section class="aero-fleet-intro-card">'+
          '<div class="aero-section-label">'+val("introLabel")+'</div>'+
          '<h2>'+val("introTitle")+'</h2>'+
          '<p>'+val("introText")+'</p>'+
        '</section>'+
        '<section class="aero-aircraft-list">'+
          records.map(renderConnectedAssetCard).join('')+
        '</section>'+
      '</main>'+
    '</div>'+
  '</section>';
...
window.SYNCETC_ASSET_RECORD_COUNT=function(){
  var records=connectedAssetRecords();
  console.log("SYNCETC_ASSET_RECORD_COUNT",records.length,records);
