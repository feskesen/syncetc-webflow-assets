...
/* PAGE-DESIGN-STUDIO-v63.js | strict Assets page row selection fix | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v63";
...
var STYLE_ID="syncetc-design-studio-v63-style";
...
function livePageTextValues(){
  var canonical=strictCurrentSettingsKey ? strictCurrentSettingsKey() : normalizeSettingsPageKeyForCompare(selectedPageKey());
  if(canonical==="aircraft")return strictPageSettingsForKey("aircraft");
  return Object.assign({},obj(selectedPageRow().settings_json),obj(selectedPageRow().current_settings_json));
}
...
function valuesForSharedAssetsRenderer(records){
  ...
  var strictSavedValues=strictPageSettingsForKey("aircraft");
  var appliedValues=state.sideAppliedValues||{};
  var vals=Object.assign({},loadedBridge,strictSavedValues,appliedValues);
...
function v63StrictDiscardPageText(){
  var key=strictCurrentSettingsKey();
  var values=strictPageSettingsForKey(key);
  state.sideDraftValues=cloneObj(values);
  state.sideAppliedValues={};
  state.sideDirty=false;
  state.sideAppliedDirty=false;
