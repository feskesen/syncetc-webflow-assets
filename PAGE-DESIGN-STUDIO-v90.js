...
/* PAGE-DESIGN-STUDIO-v90.js | Uses true shared SyncEtc header component | Generated: 2026-06-03 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v90";
...
var STYLE_ID="syncetc-design-studio-v90-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V90){
    window.__SYNCETC_DS_ESC_CLOSE_V90=true;
...
window.SYNCETC_V90_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V90,
  ...
  console.log('SYNCETC_V90_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V90_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V90_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V90_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V90_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V90_SCOPE_STATE",out);
  return out;
};
...
window.SYNCETC_V90_STUDIO_STATE=function(){
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V90_STUDIO_STATE",out);
  return out;
};
...
/* v81 Design Studio header normalizer - BEGIN */
  ...
  function renderToolHeader(active,title,description,eyebrow){eyebrow=eyebrow||"SYNCETC PLATFORM TOOL";return '<section class="syncetc-tool-header"><div class="syncetc-tool-header-brand"><img class="syncetc-tool-header-logo" src="'+esc(LOGO_URL)+'" alt="SyncEtc"></div><div class="syncetc-tool-header-body"><div><div class="syncetc-tool-header-eyebrow">'+esc(eyebrow)+'</div><h1 class="syncetc-tool-header-title">'+esc(title)+'</h1><p class="syncetc-tool-header-description">'+esc(description)+'</p></div><nav class="syncetc-tool-header-nav" aria-label="SyncEtc tools">'+toolHeaderButton("Hub","/syncetc-landing-page",active==="hub")+toolHeaderButton("Customer Manager","/customer-manager",active==="customer-manager")+toolHeaderButton("Layout Designer","/design-studio",active==="layout-designer")+toolHeaderButton("Page Setup","/page-builder",active==="page-setup")+'</nav></div></section>';}


  function installToolHeaderStyle(){
    if(document.getElementById("syncetc-tool-header-v4-style"))return;
    var style=document.createElement("style");
    style.id="syncetc-tool-header-v4-style";
    style.textContent=".syncetc-tool-header{position:relative;overflow:hidden;border:1px solid rgba(7,22,51,.12);border-radius:30px;background:linear-gradient(135deg,rgba(255,255,255,.97),rgba(239,248,255,.97));padding:24px 28px;box-shadow:0 20px 60px rgba(7,22,51,.09);margin-bottom:18px;display:flex;align-items:center;justify-content:space-between;gap:18px;flex-wrap:wrap}\n.syncetc-tool-header:before{content:'';position:absolute;inset:auto -120px -160px auto;width:340px;height:340px;border-radius:999px;background:linear-gradient(135deg,rgba(0,164,224,.14),rgba(255,91,0,.13));filter:blur(4px)}\n.syncetc-tool-header-main{position:relative;min-width:260px;flex:1}\n.syncetc-tool-header-brandline{display:flex;align-items:center;gap:20px;flex-wrap:wrap;margin-bottom:0}\n.syncetc-tool-header-logo{display:block;width:180px;max-width:46vw;height:auto}\n.syncetc-tool-header-title{font-size:42px;line-height:.94;margin:0;letter-spacing:-.04em;color:#071633;font-style:italic;font-weight:950;transform:translateY(4px)}\n.syncetc-tool-header-nav{position:relative;display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end}\n.syncetc-tool-header-btn{display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(7,22,51,.16);border-radius:999px;padding:10px 14px;background:#fff;color:#071633!important;text-decoration:none!important;font-weight:950;font-size:13px;box-shadow:0 8px 22px rgba(7,22,51,.08);white-space:nowrap}\n.syncetc-tool-header-btn.is-active{background:#071633;color:#fff!important;border-color:#071633;box-shadow:0 10px 24px rgba(7,22,51,.16)}\n.syncetc-tool-header-btn:focus{outline:3px solid rgba(0,164,224,.30);outline-offset:2px}\n@media(max-width:760px){.syncetc-tool-header{padding:22px;align-items:flex-start}.syncetc-tool-header-logo{width:150px}.syncetc-tool-header-title{font-size:34px;transform:translateY(3px)}.syncetc-tool-header-nav{justify-content:flex-start}}";
    document.head.appendChild(style);
  }
  function toolHeaderButton(label,href,active){return '<a class="syncetc-tool-header-btn '+(active?'is-active':'')+'" href="'+esc(href)+'">'+esc(label)+'</a>';}
  function renderToolHeaderShared(active,title){
    installToolHeaderStyle();
    return '<section class="syncetc-tool-header"><div class="syncetc-tool-header-main"><div class="syncetc-tool-header-brandline"><img class="syncetc-tool-header-logo" src="'+esc(LOGO_URL)+'" alt="SyncEtc"><h1 class="syncetc-tool-header-title">'+esc(title)+'</h1></div></div><nav class="syncetc-tool-header-nav" aria-label="SyncEtc tools">'+toolHeaderButton("Hub","/syncetc-landing-page",active==="hub")+toolHeaderButton("Customer Manager","/customer-manager",active==="customer-manager")+toolHeaderButton("Layout Designer","/design-studio",active==="layout-designer")+toolHeaderButton("Page Setup","/page-builder",active==="page-setup")+'</nav></section>';
  }

function requireToolHeader(){if(!window.SyncEtcToolHeader||typeof window.SyncEtcToolHeader.render!=="function")throw new Error("SyncEtcToolHeader component must be loaded before this page script.");}
function v90NormalizeDesignStudioHeader(){
  requireToolHeader();
  var root=document.getElementById(ROOT_ID);
  if(!root)return;
  var existing=root.querySelector(".syncetc-tool-header");
  if(existing)return;
  var wrap=document.createElement("div");
  wrap.innerHTML=window.SyncEtcToolHeader.render({active:"layout-designer"});
  var header=wrap.firstChild;
  var first=root.firstElementChild;
  if(first)root.insertBefore(header,first);else root.appendChild(header);
}
...
function v90InstallPlatformToolRow(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;
  v90NormalizeDesignStudioHeader();
}
/* v85 platform tool row - END */


/* v85 Design Studio diagnostic - BEGIN */
window.SYNCETC_V90_TOOL_STATE=function(){
  var out={
    version:VERSION,
    ...
    platformRows:document.querySelectorAll('.ds-v90-platform-row').length,
    authTokenPresent:!!getToken(),
    authEmail:state.authEmail||""
  };
  console.log("SYNCETC_V90_TOOL_STATE",out);
  return out;
};
/* v85 Design Studio diagnostic - END */

if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start);else start();setTimeout(v90NormalizeDesignStudioHeader,50);setTimeout(v90NormalizeDesignStudioHeader,300);setTimeout(v90InstallPlatformToolRow,80);setTimeout(v90InstallPlatformToolRow,350);
