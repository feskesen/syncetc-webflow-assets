...
/* PAGE-DESIGN-STUDIO-v79.js | forward restore 150th baseline and narrow demo registry separation | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v79";
...
var STYLE_ID="syncetc-design-studio-v79-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V79){
    window.__SYNCETC_DS_ESC_CLOSE_V79=true;
...
window.SYNCETC_V79_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V79,
  ...
  console.log('SYNCETC_V79_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V79_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V79_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V79_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V79_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V79_SCOPE_STATE",out);
  return out;
};
