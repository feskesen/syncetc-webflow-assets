/* PAGE-DESIGN-STUDIO-v37.js | dropdown-backed inheritance audit | Generated: 2026-06-01 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v37";
...
var STYLE_ID="syncetc-design-studio-v37-style";
...
function getSelected(label,settingNames){
  ...
  var stateNames={
    "Customer profile":["customer_key","customerKey","selectedCustomer","activeCustomer"],
    "Design profile":["profile_key","selectedProfile","designProfile","activeProfile"],
    "Layout preset":["layout_key","selectedLayout","layout"],
    "Style preset":["style_key","selectedStyle","style"],
    "Typography preset":["typography_key","selectedTypography","typography"],
    "Color theme":["color_key","selectedColor","colorTheme","theme"],
    "Effect preset":["effect_key","selectedEffect","effect"],
    "Default width":["width_key","defaultWidth","width"],
    "Header style":["header_key","header"],
    "Hero style":["hero_key","hero"],
    "Section rhythm":["section_rhythm_key","rhythm"],
    "Density":["density_key","density"],
    "Shadows":["shadow_key","shadows"],
    "Borders":["border_key","borders"],
    "Corners":["corner_key","corners","radius"],
    "Gradients":["gradient_key","gradients"],
    "Motion":["motion_key","motion"],
    "Background":["background_key","background"],
    "Image treatment":["image_treatment_key","imageTreatment"],
    "Divider style":["divider_key","divider"],
    "Emphasis style":["emphasis_key","emphasis"],
    "Surface/card style":["surface_key","surface","cardStyle"]
  }[label]||[];

  for(var j=0;j<stateNames.length;j++){
    var sv=state[stateNames[j]];
...
function listHasKey(list,key){
  ...
  if(Array.isArray(val)){
    return val.some(function(item){
      item=obj(item);
      return clean(item.key||item.slug||item.name||item.id||item.value)===key || clean(item.label)===key;
    });
  }
