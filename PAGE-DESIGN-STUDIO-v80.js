...
/* PAGE-DESIGN-STUDIO-v80.js | Design Studio 2.1 visual layout editor shell | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v80";
...
var STYLE_ID="syncetc-design-studio-v80-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V80){
    window.__SYNCETC_DS_ESC_CLOSE_V80=true;
...
window.SYNCETC_V80_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V80,
  ...
  console.log('SYNCETC_V80_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V80_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V80_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V80_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V80_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V80_SCOPE_STATE",out);
  return out;
};
...
window.SYNCETC_V80_STUDIO_STATE=function(){
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V80_STUDIO_STATE",out);
  return out;
};
