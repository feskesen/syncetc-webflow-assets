...
/* PAGE-DESIGN-STUDIO-v43.js | Info page selectable preview and customer context model | Generated: 2026-06-01 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v43";
...
var STYLE_ID="syncetc-design-studio-v43-style";
    ...
    '<div class="aero-info-shell">'+
      ...
      '<main class="aero-info-main">'+
        '<div class="aero-info-column">'+
          '<section class="aero-section-card"><div class="aero-section-label">'+pick("sections.0.label","Overview")+'</div><h2>'+pick("sections.0.title","About this organization")+'</h2><p>'+pick("sections.0.body.0","")+'</p><p>'+pick("sections.0.body.1","")+'</p></section>'+
          '<section class="aero-section-card"><div class="aero-section-label">'+pick("sections.1.label","Membership")+'</div><h2>'+pick("sections.1.title","Shared responsibility")+'</h2><p>'+pick("sections.1.body.0","")+'</p><p>'+pick("sections.1.body.1","")+'</p></section>'+
          '<section class="aero-section-card"><div class="aero-section-label">'+pick("boardLabel","Board & Officers")+'</div><h2>'+pick("boardTitle","Current officers")+'</h2><p>'+pick("boardIntro","")+'</p></section>'+
        '</div>'+
        '<aside class="aero-info-column"><section class="aero-faq-panel"><div class="aero-faq-header"><div class="aero-section-label">'+pick("faqLabel","FAQs")+'</div><h2>'+pick("faqTitle","Frequently Asked Questions")+'</h2><p>'+pick("faqIntro","")+'</p></div><div class="aero-faq-list"><div class="aero-faq-item is-open"><button class="aero-faq-question" type="button"><span>Sample FAQ preview</span><span class="aero-faq-icon">+</span></button><div class="aero-faq-answer"><p>FAQ records remain page data; the first editable fields control the panel copy.</p></div></div></div></section></aside>'+
      '</main>'+
