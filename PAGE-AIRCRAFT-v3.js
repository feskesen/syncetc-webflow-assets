/* PAGE-AIRCRAFT-v3.js - BEGIN */
(function () {
  "use strict";

  const VERSION = "PAGE-AIRCRAFT-v3";
  const MOUNT_ID = "syncetc-webflow-mount";
  const STYLE_ID = "syncetc-aircraft-page-v3-style";
  ...
  function ensureComponents() {
    ...
    return COMPONENT_FILES.reduce(function(p, file) {
      return p.then(function() {
        return loadScriptOnce(base + file + "?v=page-aware-customer-settings-aircraft-3");
      });
    }, Promise.resolve());
  }
