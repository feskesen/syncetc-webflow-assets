...
function installStyles(){U().installStyle("COMPONENT-master-controls-v12-style",`.se-workbench{max-width:1180px;margin:8px auto 16px;padding:0 18px}.se-editor{background:rgba(255,255,255,.96);border:1px solid var(--se-aero-border);border-radius:22px;box-shadow:var(--se-aero-shadow);overflow:hidden}.se-editor-top{display:flex;justify-content:space-between;gap:12px;align-items:center;padding:10px 14px;background:linear-gradient(135deg,var(--se-aero-navy),var(--se-aero-blue));color:#fff}.se-editor-title{display:flex;gap:8px;align-items:center;flex-wrap:wrap}.se-editor-title h2{margin:0;color:#fff;font-size:16px}.se-pill{display:inline-flex;padding:4px 9px;border-radius:999px;background:rgba(255,255,255,.16);border:1px solid rgba(255,255,255,.24);color:#fff;font-size:10.5px;font-weight:900;text-transform:uppercase}.se-toggle{border:1px solid rgba(255,255,255,.32);border-radius:999px;padding:8px 12px;background:#fff;color:var(--se-aero-navy);font-size:12px;font-weight:900;cursor:pointer}.se-editor-body{display:none;background:#f8fbff;border-top:1px solid rgba(255,255,255,.24)}.se-editor.is-open .se-editor-body{display:block}.se-grid{display:grid;grid-template-columns:1fr 1fr}.se-panel{padding:16px;border-right:1px solid var(--se-aero-border)}.se-panel:last-child{border-right:0;background:#fff}.se-panel h3{margin:0 0 8px;color:var(--se-aero-navy);font-size:15px}.se-help{margin:0 0 12px;color:#657789;font-size:12px;line-height:1.35;font-weight:700}.se-row{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px}.se-control{display:block}.se-control span{display:block;margin-bottom:5px;color:var(--se-aero-navy);font-size:11px;font-weight:900;text-transform:uppercase}.se-control input,.se-control select,.se-control textarea{width:100%;border:1px solid rgba(18,54,90,.20);border-radius:11px;padding:9px 10px;font:inherit;font-size:13px;background:#fff;color:var(--se-aero-text)}.se-control textarea{min-height:70px;resize:vertical}.se-control small{display:block;margin-top:4px;color:#657789;font-size:11px}.se-viewas{display:flex;flex-wrap:wrap;gap:8px;margin:8px 0 14px}.se-view{border:1px solid rgba(18,54,90,.20);border-radius:999px;padding:8px 11px;background:#fff;color:var(--se-aero-navy);font-size:12px;font-weight:900;cursor:pointer}.se-view.active{background:var(--se-aero-navy);color:#fff;border-color:var(--se-aero-navy)}.se-actions{display:flex;flex-wrap:wrap;gap:8px;margin-top:12px}.se-actions button{border:1px solid rgba(18,54,90,.20);border-radius:999px;padding:9px 12px;background:var(--se-aero-navy);color:#fff;font-weight:900;cursor:pointer}.se-actions button.secondary{background:#fff;color:var(--se-aero-navy)}.se-status{margin-top:9px;min-height:18px;color:#304d73;font-size:12px;font-weight:900}.se-status.warn{color:#8f2424}.se-status.good{color:#247245}.se-card{border:1px solid var(--se-aero-border);border-radius:18px;overflow:hidden;background:var(--se-aero-card);box-shadow:0 10px 28px rgba(12,38,64,.10)}.se-card-hero{padding:18px;color:#fff;background:linear-gradient(135deg,var(--se-aero-navy),var(--se-aero-blue))}.se-card-hero h4{margin:5px 0 8px;font-size:22px;color:#fff}.se-card-hero p{margin:0;color:rgba(255,255,255,.92)}.se-card-body{padding:13px;background:#fff}.se-preview-pills{display:flex;gap:8px;flex-wrap:wrap}.se-preview-pills span{border:1px solid var(--se-aero-border);border-radius:999px;padding:7px 9px;background:#fff;color:var(--se-aero-navy);font-size:12px;font-weight:900}@media(max-width:980px){.se-grid{grid-template-columns:1fr}.se-panel{border-right:0;border-bottom:1px solid var(--se-aero-border)}.se-row{grid-template-columns:1fr}}`);}
...
/* COMPONENT-master-controls-v12.js - END */
