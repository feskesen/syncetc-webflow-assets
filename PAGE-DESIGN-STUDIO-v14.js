/* PAGE-DESIGN-STUDIO-v14.js | functional save profile and clearer save errors | Generated: 2026-06-01 08:35:00 UTC */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v14";
...
var STYLE_ID="syncetc-design-studio-v14-style";
...
function saveNewDesignProfile(){
  var token=getToken();
  if(!token){state.error='Sign in as a platform admin before saving a Design Profile.';state.notice='';updateStatus();return;}
