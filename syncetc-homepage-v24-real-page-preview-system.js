/* syncetc-homepage-v24-real-page-preview-system.js - BEGIN */
/*
  Hosted SyncEtc Webflow asset.
  Update 96 / JS v24: real multi-page preview system, 150th production preset, and display-setting proof.
  Upload this file as:
  syncetc-homepage-v24-real-page-preview-system.js
...
/* syncetc_update_96_real_page_preview_system - BEGIN */
(function () {
  const ROOT_ID = "syncetc-generated-homepage-v2";
  const WB_ID = "syncetc-real-page-preview-workbench-v24";
  const STYLE_ID = "syncetc-real-page-preview-v24-style";
  const VERSION_LABEL = "JS v24-real-page-preview-system";
  const FILE_NAME = "syncetc-homepage-v24-real-page-preview-system.js";
  const STORAGE_KEY = "syncetc_v24_real_page_preview_state";

  const STYLE_PRESETS = {
    "150th-aero-v1": {
      label: "150th Aero Style v1",
      status: "Production demo preset",
      note: "Primary selling/demo style. Aviation blue, high-contrast surfaces, operational club feel.",
      primary: "#12365a",
      secondary: "#0f4d72",
      accent: "#2f80c4",
      bg: "#eef5fa",
      ...
      radius: "22px",
      buttonRadius: "999px",
      shadow: "0 18px 48px rgba(18,54,90,.16)",
      heroTreatment: "blue-gradient-card"
    },
    "style-slot-2-classic-club": {
      label: "Style Slot 2 - Classic Club",
      status: "Future preset placeholder",
      note: "Reserved for a warmer traditional club style after 150th is complete.",
      primary: "#4a2f1a", secondary: "#6f4a24", accent: "#b28a47", bg: "#fbf4e8", surface: "rgba(255,255,255,.95)", text: "#2f241a", muted: "#725f49", radius: "18px", buttonRadius: "14px", shadow: "0 16px 38px rgba(74,47,26,.14)", heroTreatment: "warm-card"
    },
    "style-slot-3-modern-ops": {
      label: "Style Slot 3 - Modern Ops",
      status: "Future preset placeholder",
      note: "Reserved for FBO/school/fleet customers who need a portal-forward operations look.",
      primary: "#172033", secondary: "#1e3a8a", accent: "#38bdf8", bg: "#eef3f8", surface: "rgba(255,255,255,.95)", text: "#172033", muted: "#566273", radius: "16px", buttonRadius: "10px", shadow: "0 18px 44px rgba(23,32,51,.16)", heroTreatment: "ops-panel"
    },
    "style-slot-4-clean-portal": {
      label: "Style Slot 4 - Clean Portal",
      status: "Future preset placeholder",
      note: "Reserved for customers who want portal/admin tools more than a full public site.",
      primary: "#27323a", secondary: "#475569", accent: "#64748b", bg: "#f4f6f8", surface: "rgba(255,255,255,.96)", text: "#27323a", muted: "#64748b", radius: "14px", buttonRadius: "999px", shadow: "0 14px 34px rgba(39,50,58,.12)", heroTreatment: "clean-card"
    }
  };

  const PAGE_MODELS = {
    home: {
      label: "Home", audience: "public", eyebrow: "Aviation club operations", title: "150th Aero Flying Club", subtitle: "A polished SyncEtc-powered public homepage for club operations, events, documents, and member access.", primary: "View dashboard", secondary: "Apply / Contact", sections: [
        ["Upcoming Events", "Meeting and fly-out highlights with RSVP-ready paths."],
        ["Member Resources", "Minutes, rules, procedures, and controlled club documents."],
        ["Gallery", "Featured club photos and approved media."],
        ["Aircraft", "Fleet overview and aircraft-specific resources."]
      ]
    },
    events: {
      label: "Events", audience: "public", eyebrow: "Calendar and RSVP", title: "Events and RSVP", subtitle: "A customer-facing events page for meetings, training, fly-outs, maintenance windows, and supply planning.", primary: "View calendar", secondary: "RSVP help", sections: [
        ["Next Meeting", "Date, time, location, agenda preview, and RSVP button."],
        ["Fly-outs", "Member trip planning, expected attendance, and notes."],
        ["Maintenance Windows", "Operational notices without exposing private admin details."],
        ["Admin Tools", "Create, duplicate, and manage events after authentication is built."]
      ]
    },
    documents: {
      label: "Documents", audience: "member", eyebrow: "Resources and records", title: "Documents and Resources", subtitle: "Rules, minutes, aircraft resources, oil reports, and administrative documents grouped by audience and permission.", primary: "Open resources", secondary: "Request document", sections: [
        ["Member Minutes", "Approved member meeting minutes and searchable archive."],
        ["Board/Admin Docs", "Private documents hidden until authenticated and scoped."],
        ["Aircraft Documents", "POH, avionics manuals, checklists, and operating resources."],
        ["Document Editor", "Future in-house source/published document workflow."]
      ]
    },
    gallery: {
      label: "Gallery", audience: "public", eyebrow: "Approved media", title: "Gallery and Club Media", subtitle: "Public approved photos with member submission and admin review workflows behind the scenes.", primary: "View gallery", secondary: "Submit photo", sections: [
        ["Featured Image", "Rotating home/gallery feature controlled by approved media."],
        ["Submit", "Member upload flow with captions and attribution."],
        ["Review Queue", "Admin approval/rejection path before publication."],
        ["Optimized Storage", "Display-optimized assets, not a full archival photo lab."]
      ]
    },
    roster: {
      label: "Roster", audience: "member", eyebrow: "People and permissions", title: "Roster and People", subtitle: "Member directory, board contacts, scoped profile information, and member-management paths.", primary: "Open roster", secondary: "Update profile", sections: [
        ["Member Directory", "Searchable roster for authorized members."],
        ["Board Contacts", "Role-based board/officer contact cards."],
        ["Profile Updates", "Member-maintained fields with admin review where needed."],
        ["Access Roles", "Member/admin/support permissions as the platform matures."]
      ]
    },
    member_dashboard: {
      label: "Member Dashboard", audience: "member", eyebrow: "Member portal", title: "Member Dashboard", subtitle: "The logged-in member home base for events, resources, profile, fun pages, and operational shortcuts.", primary: "My profile", secondary: "Club resources", sections: [
        ["Quick Links", "Roster, events, documents, gallery, and dashboard cards."],
        ["Alerts", "Member-scoped reminders and operational notices."],
        ["Fun Modules", "Where We’ve Been, Discord/forum, and other optional engagement pages."],
        ["Account", "Profile and member data update paths."]
      ]
    },
    admin_dashboard: {
      label: "Admin Dashboard", audience: "admin", eyebrow: "Admin operations", title: "Admin Dashboard", subtitle: "A scoped operations center for customers to manage content, members, documents, events, alerts, and settings.", primary: "Manage content", secondary: "System settings", sections: [
        ["Content", "Homepage, documents, gallery, events, and page copy."],
        ["People", "Members, roles, access, and profile management."],
        ["Operations", "Aircraft, reports, maintenance, alerts, and records."],
        ["Settings", "Preset choice, domains/email readiness, modules, and deployment mode."]
      ]
    }
  };
  ...
  function defaultState() {
    return {
      presetKey: "150th-aero-v1",
      pageKey: "home",
      audienceKey: "public",
      density: "standard",
      controlsSide: "left",
      showFuturePresets: true,
      showTechnicalPanels: false,
      showCustomerChangeProof: true
    };
  }
  function readState() {
    let stored = null;
    try { stored = JSON.parse(window.localStorage.getItem(STORAGE_KEY) || "null"); } catch (e) {}
    return Object.assign(defaultState(), stored || {});
  }
  function saveState(state) {
    try { window.localStorage.setItem(STORAGE_KEY, JSON.stringify(state)); } catch (e) {}
    const r = root();
    if (r) r.setAttribute("data-syncetc-v24-state", JSON.stringify(state));
  }
  ...
  function injectStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      .syncetc-homepage-v2 { --v24-primary:#12365a; --v24-secondary:#0f4d72; --v24-accent:#2f80c4; --v24-bg:#eef5fa; --v24-surface:rgba(255,255,255,.95); --v24-text:#15324a; --v24-muted:#5d7285; --v24-radius:22px; --v24-button-radius:999px; --v24-shadow:0 18px 48px rgba(18,54,90,.16); }
      .se-v24-version-bar { position:sticky; top:0; z-index:999997; background:var(--v24-primary); color:#fff; border-bottom:3px solid var(--v24-accent); padding:10px 14px; text-align:center; font:900 13px/1.2 Arial,sans-serif; letter-spacing:.02em; }
      .se-v24-version-badge { position:fixed; right:12px; top:12px; z-index:999999; background:var(--v24-primary); color:#fff; border:1px solid rgba(255,255,255,.6); border-radius:999px; padding:8px 11px; box-shadow:0 8px 24px rgba(0,0,0,.24); font:900 12px/1 Arial,sans-serif; pointer-events:none; }
      .se-v24-hidden-info { display:none !important; }
      .syncetc-homepage-v2.se-v24-show-technical .se-v24-hidden-info { display:block !important; }
      .se-v24-workbench { max-width:1180px; margin:18px auto; border:1px solid rgba(18,54,90,.16); border-radius:24px; background:#fff; box-shadow:var(--v24-shadow); overflow:hidden; color:var(--v24-text); }
      .se-v24-head { display:flex; justify-content:space-between; align-items:flex-start; gap:16px; padding:18px 20px; background:linear-gradient(135deg,var(--v24-primary),var(--v24-secondary)); color:#fff; }
      .se-v24-head h2 { margin:0 0 4px; color:#fff; font-size:24px; letter-spacing:-.02em; line-height:1.05; }
      .se-v24-head p { margin:0; color:rgba(255,255,255,.88); max-width:780px; line-height:1.35; }
      .se-v24-badges { display:flex; flex-wrap:wrap; justify-content:flex-end; gap:7px; min-width:230px; }
      .se-v24-badges span { display:inline-flex; padding:7px 9px; border-radius:999px; background:rgba(255,255,255,.93); color:var(--v24-primary); font-size:11px; font-weight:950; white-space:nowrap; }
      .se-v24-body { display:grid; grid-template-columns:330px minmax(0,1fr); min-height:620px; }
      .se-v24-body.controls-right { grid-template-columns:minmax(0,1fr) 330px; }
      .se-v24-body.controls-right .se-v24-controls { order:2; border-right:0; border-left:1px solid rgba(18,54,90,.13); }
      .se-v24-controls { background:#f8fafc; border-right:1px solid rgba(18,54,90,.13); padding:16px; }
      .se-v24-controls h3 { margin:0 0 8px; color:var(--v24-primary); font-size:14px; }
      .se-v24-control { margin-bottom:12px; padding:10px; border:1px solid rgba(18,54,90,.12); border-radius:14px; background:#fff; }
      .se-v24-control label { display:block; margin-bottom:6px; color:var(--v24-primary); font-size:12px; font-weight:900; }
      .se-v24-control select, .se-v24-control input[type="text"] { width:100%; box-sizing:border-box; border:1px solid rgba(18,54,90,.18); border-radius:10px; padding:8px 9px; background:#fff; color:var(--v24-text); font:inherit; }
      .se-v24-control small { display:block; margin-top:6px; color:var(--v24-muted); font-size:11px; line-height:1.25; }
      .se-v24-check { display:flex; gap:8px; align-items:flex-start; font-size:12px; font-weight:800; color:var(--v24-text); margin:8px 0; }
      .se-v24-control-actions { display:flex; gap:8px; flex-wrap:wrap; margin-top:10px; }
      .se-v24-control-actions button { border:1px solid rgba(18,54,90,.18); border-radius:999px; padding:8px 10px; background:var(--v24-primary); color:#fff; font-weight:900; cursor:pointer; }
      .se-v24-control-actions button.secondary { background:#fff; color:var(--v24-primary); }
      .se-v24-preview { padding:18px; background:linear-gradient(180deg,var(--v24-bg),#fff); }
      .se-v24-preview-heading { display:flex; justify-content:space-between; align-items:center; gap:10px; margin-bottom:12px; color:var(--v24-primary); font-weight:950; font-size:12px; text-transform:uppercase; letter-spacing:.05em; }
      .se-v24-customer-view { border:1px solid rgba(18,54,90,.15); border-radius:var(--v24-radius); background:var(--v24-surface); box-shadow:var(--v24-shadow); overflow:hidden; }
      .se-v24-final-nav { display:flex; justify-content:space-between; align-items:center; gap:12px; padding:12px 16px; border-bottom:1px solid rgba(18,54,90,.10); background:rgba(255,255,255,.9); }
      .se-v24-brand { display:flex; gap:10px; align-items:center; min-width:0; }
      .se-v24-mark { width:40px; height:40px; border-radius:13px; background:linear-gradient(135deg,var(--v24-primary),var(--v24-accent)); box-shadow:inset 0 0 0 1px rgba(255,255,255,.25); flex:0 0 auto; }
      .se-v24-brand strong { display:block; color:var(--v24-primary); font-size:15px; line-height:1.05; }
      .se-v24-brand span { display:block; color:var(--v24-muted); font-size:11px; margin-top:2px; }
      .se-v24-nav-links { display:flex; gap:7px; flex-wrap:wrap; justify-content:flex-end; }
      .se-v24-nav-links span { display:inline-flex; padding:7px 9px; border:1px solid rgba(18,54,90,.12); border-radius:999px; background:#fff; color:var(--v24-primary); font-size:11px; font-weight:900; }
      .se-v24-final-hero { display:grid; grid-template-columns:minmax(0,1.18fr) minmax(280px,.82fr); gap:22px; align-items:center; padding:30px; }
      .se-v24-final-hero .eyebrow { margin:0 0 9px; color:var(--v24-accent); font-weight:950; letter-spacing:.10em; text-transform:uppercase; font-size:11px; }
      .se-v24-final-hero h1 { margin:0; color:var(--v24-primary); font-size:clamp(32px,5vw,58px); line-height:.98; letter-spacing:-.04em; }
      .se-v24-final-hero p { margin:12px 0 0; color:var(--v24-muted); font-size:16px; line-height:1.55; max-width:720px; }
      .se-v24-actions { display:flex; gap:10px; flex-wrap:wrap; margin-top:18px; }
      .se-v24-actions span { display:inline-flex; padding:10px 13px; border-radius:var(--v24-button-radius); border:1px solid rgba(18,54,90,.14); background:#fff; color:var(--v24-primary); font-size:13px; font-weight:950; }
      .se-v24-actions span.primary { background:var(--v24-primary); color:#fff; border-color:var(--v24-primary); }
      .se-v24-hero-card { padding:20px; border-radius:calc(var(--v24-radius) - 4px); background:linear-gradient(135deg,var(--v24-primary),var(--v24-secondary)); color:#fff; min-height:250px; display:flex; flex-direction:column; justify-content:space-between; box-shadow:inset 0 0 0 1px rgba(255,255,255,.16); }
      .se-v24-hero-card .card-title { font-size:12px; font-weight:950; letter-spacing:.09em; text-transform:uppercase; color:rgba(255,255,255,.82); }
      .se-v24-hero-card .card-big { margin-top:8px; font-size:28px; line-height:1.05; font-weight:950; }
      .se-v24-hero-card .card-note { margin-top:10px; color:rgba(255,255,255,.86); line-height:1.35; font-size:13px; }
      .se-v24-section-grid { display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:12px; padding:0 30px 30px; }
      .se-v24-section-card { border:1px solid rgba(18,54,90,.12); border-radius:calc(var(--v24-radius) - 6px); background:rgba(255,255,255,.88); padding:14px; min-height:138px; }
      .se-v24-section-card strong { display:block; color:var(--v24-primary); font-size:15px; line-height:1.15; }
      .se-v24-section-card span { display:block; color:var(--v24-muted); margin-top:7px; line-height:1.35; font-size:12px; }
      .se-v24-proof { margin-top:12px; border:1px dashed rgba(18,54,90,.22); border-radius:14px; background:rgba(255,255,255,.76); padding:10px 12px; color:var(--v24-primary); font-size:12px; font-weight:850; }
      .se-v24-export-status { display:none; margin-top:8px; padding:8px 10px; border-radius:12px; background:#eaf6ff; color:var(--v24-primary); font-size:12px; font-weight:900; }
      @media (max-width:1000px) { .se-v24-body, .se-v24-body.controls-right { grid-template-columns:1fr; } .se-v24-controls { border-right:0; border-bottom:1px solid rgba(18,54,90,.13); } .se-v24-final-hero { grid-template-columns:1fr; } .se-v24-section-grid { grid-template-columns:repeat(2,minmax(0,1fr)); } }
      @media (max-width:640px) { .se-v24-final-nav { align-items:flex-start; flex-direction:column; } .se-v24-section-grid { grid-template-columns:1fr; } }
    `;
    document.head.appendChild(style);
  }
  ...
  function applyPreset(preset) {
    const r = root();
    if (!r) return;
    r.style.setProperty("--v24-primary", preset.primary);
    r.style.setProperty("--v24-secondary", preset.secondary);
    r.style.setProperty("--v24-accent", preset.accent);
    r.style.setProperty("--v24-bg", preset.bg);
    r.style.setProperty("--v24-surface", preset.surface);
    r.style.setProperty("--v24-text", preset.text);
    r.style.setProperty("--v24-muted", preset.muted);
    r.style.setProperty("--v24-radius", preset.radius);
    r.style.setProperty("--v24-button-radius", preset.buttonRadius);
    r.style.setProperty("--v24-shadow", preset.shadow);
  }

  function updateVersionMarkers() {
    let bar = document.getElementById("syncetc-v24-version-bar");
    if (!bar) { bar = document.createElement("div"); bar.id = "syncetc-v24-version-bar"; bar.className = "se-v24-version-bar"; document.body.insertBefore(bar, document.body.firstChild); }
    bar.textContent = VERSION_LABEL + " loaded · " + FILE_NAME;
    let badge = document.getElementById("syncetc-v24-version-badge");
    if (!badge) { badge = document.createElement("div"); badge.id = "syncetc-v24-version-badge"; badge.className = "se-v24-version-badge"; document.body.appendChild(badge); }
    badge.textContent = "JS v24 loaded";
    const r = root();
  ...
  function selectOptions(obj, selected) {
    return Object.keys(obj).map(function (key) {
      return '<option value="' + escapeHtml(key) + '"' + (selected === key ? ' selected' : '') + '>' + escapeHtml(obj[key].label) + '</option>';
    }).join('');
  }

  function navFor(audience) {
    if (audience === "admin") return ["Dashboard", "People", "Pages", "Documents", "Events", "Settings"];
    if (audience === "member") return ["Dashboard", "Roster", "Events", "Resources", "Gallery"];
    return ["Home", "Info", "Aircraft", "Calendar", "Gallery", "Apply"];
  }

  function renderCustomerView(state) {
    const preset = STYLE_PRESETS[state.presetKey] || STYLE_PRESETS["150th-aero-v1"];
    const page = PAGE_MODELS[state.pageKey] || PAGE_MODELS.home;
    const nav = navFor(state.audienceKey);
    const cards = page.sections.map(function (sec) {
      return '<article class="se-v24-section-card"><strong>' + escapeHtml(sec[0]) + '</strong><span>' + escapeHtml(sec[1]) + '</span></article>';
    }).join('');
    return '<div class="se-v24-customer-view" data-se-v24-customer-view>' +
      '<div class="se-v24-final-nav"><div class="se-v24-brand"><div class="se-v24-mark"></div><div><strong>150th Aero Flying Club</strong><span>' + escapeHtml(preset.label) + ' · ' + escapeHtml(state.audienceKey) + ' view</span></div></div><div class="se-v24-nav-links">' + nav.map(function (n) { return '<span>' + escapeHtml(n) + '</span>'; }).join('') + '</div></div>' +
      '<section class="se-v24-final-hero"><div><div class="eyebrow">' + escapeHtml(page.eyebrow) + '</div><h1>' + escapeHtml(page.title) + '</h1><p>' + escapeHtml(page.subtitle) + '</p><div class="se-v24-actions"><span class="primary">' + escapeHtml(page.primary) + '</span><span>' + escapeHtml(page.secondary) + '</span></div></div><aside class="se-v24-hero-card"><div><div class="card-title">Live customer view</div><div class="card-big">' + escapeHtml(page.label) + '</div><div class="card-note">Every control on the left immediately changes this preview. This is the sales/demo customer-facing page model, not a raw style lab.</div></div><div class="card-note">Preset: ' + escapeHtml(preset.status) + '</div></aside></section>' +
      '<section class="se-v24-section-grid">' + cards + '</section>' +
      '</div>';
  }
  ...
  function stateExport(state) {
    ...
    const page = PAGE_MODELS[state.pageKey] || PAGE_MODELS.home;
    return {
      export_type: "syncetc_v24_customer_view_setting_proof",
      version: VERSION_LABEL,
      file_name: FILE_NAME,
      exported_at: new Date().toISOString(),
      product_direction: "Build one polished 150th Aero site first, using preset bones for later vetted style expansion.",
      selected_settings: state,
      selected_preset: preset,
      selected_page_model: page,
      proof: "Changing the display controls immediately changes the customer-view preview. Customer-facing style selection should start with curated presets, not raw unlimited controls."
    };
  }
  ...
  function hideOldPanels(state) {
    const r = root();
    if (!r) return;
    r.classList.toggle("se-v24-show-technical", !!state.showTechnicalPanels);
    ["[data-se-admin-preview]", "[data-se-admin-editing-preview]", "[data-se-navigation-preview]", "[data-se-backbone-preview]", "[data-se-deployment-access-preview]", "[data-se-boundary-preview]"].forEach(function (sel) {
      const el = r.querySelector(sel);
      if (el) el.classList.add("se-v24-hidden-info");
    });
  }
  ...
  function renderWorkbench() {
    ...
    applyPreset(preset);
    hideOldPanels(state);
    let wb = document.getElementById(WB_ID);
    if (!wb) {
      wb = document.createElement("section");
      wb.id = WB_ID; wb.className = "se-v24-workbench";
    ...
    const bodyClass = state.controlsSide === "right" ? "se-v24-body controls-right" : "se-v24-body";
    wb.innerHTML = '<div class="se-v24-head"><div><h2>150th Aero Real Page Preview System</h2><p>One polished customer site first. Controls are plain. The customer view is the product preview. Preset bones remain ready for later curated styles.</p></div><div class="se-v24-badges"><span>JS v24</span><span>150th first</span><span>settings change preview</span></div></div>' +
      '<div class="' + bodyClass + '"><aside class="se-v24-controls"><h3>Plain test controls</h3>' +
        '<div class="se-v24-control"><label>Customer style preset</label><select data-se-v24-field="presetKey">' + selectOptions(STYLE_PRESETS, state.presetKey) + '</select><small>Only 150th Aero v1 is production-ready. Other slots prove the future preset model.</small></div>' +
        '<div class="se-v24-control"><label>Page design preview</label><select data-se-v24-field="pageKey">' + selectOptions(PAGE_MODELS, state.pageKey) + '</select><small>This is the page-design pivot: Home, Events, Documents, Gallery, Roster, Member, and Admin.</small></div>' +
        '<div class="se-v24-control"><label>Audience / nav view</label><select data-se-v24-field="audienceKey"><option value="public"' + (state.audienceKey === "public" ? " selected" : "") + '>Public</option><option value="member"' + (state.audienceKey === "member" ? " selected" : "") + '>Member</option><option value="admin"' + (state.audienceKey === "admin" ? " selected" : "") + '>Admin</option></select><small>Changes the customer-view navigation and framing immediately.</small></div>' +
        '<div class="se-v24-control"><label>Control panel side</label><select data-se-v24-field="controlsSide"><option value="left"' + (state.controlsSide === "left" ? " selected" : "") + '>Controls left</option><option value="right"' + (state.controlsSide === "right" ? " selected" : "") + '>Controls right</option></select><small>Lets us test whether controls-left or controls-right is better for demos.</small></div>' +
        '<div class="se-v24-control"><label>Build/testing visibility</label><label class="se-v24-check"><input type="checkbox" data-se-v24-check="showTechnicalPanels"' + (state.showTechnicalPanels ? " checked" : "") + '> Show lower technical prototype panels</label><label class="se-v24-check"><input type="checkbox" data-se-v24-check="showCustomerChangeProof"' + (state.showCustomerChangeProof ? " checked" : "") + '> Show settings-change proof note</label><small>Keep the demo page focused. Technical panels stay hidden unless needed.</small></div>' +
        '<div class="se-v24-control-actions"><button type="button" data-se-v24-action="export">Export current settings JSON</button><button type="button" class="secondary" data-se-v24-action="reset">Reset</button></div><div data-se-v24-status class="se-v24-export-status"></div>' +
      '</aside><main class="se-v24-preview"><div class="se-v24-preview-heading"><span>Customer view preview</span><span>' + escapeHtml(preset.status) + '</span></div>' + renderCustomerView(state) + (state.showCustomerChangeProof ? '<div class="se-v24-proof">Proof point: changing style preset, page design, audience, or control side updates this customer-view preview immediately. This is the path from settings to customer display.</div>' : '') + '</main></div>';
  }

  function bind() {
    if (document.documentElement.getAttribute("data-se-v24-bound") === "true") return;
    document.documentElement.setAttribute("data-se-v24-bound", "true");
    document.addEventListener("change", function (event) {
      const field = event.target.closest("[data-se-v24-field]");
      const check = event.target.closest("[data-se-v24-check]");
      if (!field && !check) return;
      const state = readState();
      if (field) state[field.getAttribute("data-se-v24-field")] = field.value;
      if (check) state[check.getAttribute("data-se-v24-check")] = check.checked;
      saveState(state);
      renderWorkbench();
    });
    document.addEventListener("click", function (event) {
      const action = event.target.closest("[data-se-v24-action]");
      if (!action) return;
      const state = readState();
      const kind = action.getAttribute("data-se-v24-action");
      if (kind === "reset") {
        try { window.localStorage.removeItem(STORAGE_KEY); } catch (e) {}
        saveState(defaultState()); renderWorkbench(); return;
      }
      if (kind === "export") {
        downloadJson("syncetc-v24-customer-view-settings.json", stateExport(state));
        const wb = document.getElementById(WB_ID); const status = wb && wb.querySelector("[data-se-v24-status]");
        if (status) { status.style.display = "block"; status.textContent = "Exported current preview settings JSON. No database write occurred."; }
      }
    });
  }

  function boot() {
    injectStyles(); updateVersionMarkers(); bind(); renderWorkbench();
    [200, 700, 1400, 2800].forEach(function (delay) { setTimeout(function () { updateVersionMarkers(); renderWorkbench(); }, delay); });
    console.log("SYNCETC UPDATE 96 REAL PAGE PREVIEW SYSTEM LOADED", VERSION_LABEL, FILE_NAME);
  }
  if (document.readyState === "loading") document.addEventListener("DOMContentLoaded", boot);
  else boot();
})();
/* syncetc_update_96_real_page_preview_system - END */


/* syncetc-homepage-v24-real-page-preview-system.js - END */
