...
/* PAGE-DESIGN-STUDIO-v44.js | restored Assets preview and styled Info preview | Generated: 2026-06-01 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v44";
...
var STYLE_ID="syncetc-design-studio-v44-style";
...
function selectedPageLabel(){
  if(state.sidePageKey==="info")return "Info / About";
...
function renderPageOptions(){
  var options=[
    {key:"info",label:"Info / About"},
    {key:"assets",label:"Assets"}
  ];
  return options.map(function(p){
    return '<option value="'+esc(p.key)+'" '+(state.sidePageKey===p.key?'selected':'')+'>'+esc(p.label)+'</option>';
  }).join("");
...
function renderSideDrawer(){
  return '<button class="ds-side-tab" type="button" data-ds-action="side-open">Page Settings</button>'+
    '<aside class="ds-side-drawer '+(state.sideOpen?'is-open':'')+'" data-ds-side-drawer>'+
      '<div class="ds-side-head"><div><h3>Page Specific Settings</h3><p>'+esc(customerName())+' · '+esc(selectedPageLabel())+'</p></div><button class="ds-side-close" type="button" data-ds-action="side-close">×</button></div>'+
...
function renderInfoPreviewForDesignStudio(){
  ...
  return '<section class="aero-info-page" data-design-studio-preview-page="info">'+
...
function renderAssetsPreviewForDesignStudio(){
  ...
  return '<section class="aero-fleet-page" data-design-studio-preview-page="assets">'+
...
function renderSelectedPagePreview(){
  if(state.sidePageKey==="info")return renderInfoPreviewForDesignStudio();
  if(state.sidePageKey==="assets"||state.sidePageKey==="aircraft")return renderAssetsPreviewForDesignStudio();
