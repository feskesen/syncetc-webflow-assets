/* COMPONENT-customer-settings-v5.js - BEGIN */
(function(){
"use strict";
window.SyncEtc=window.SyncEtc||{};
window.SyncEtc.Components=window.SyncEtc.Components||{};
var VERSION="COMPONENT-customer-settings-v5";
...
function installStyles(){
  U().installStyle("COMPONENT-customer-settings-v5-style",`
    ...
    .se-customer-settings-toggle{border:1px solid rgba(18,54,90,.20);border-radius:999px;padding:8px 12px;background:#fff;color:var(--se-aero-navy);font-size:12px;font-weight:900;cursor:pointer}.se-cs-top-actions{display:flex;align-items:center;gap:8px;flex-wrap:wrap;justify-content:flex-end}.se-cs-top-identity{display:flex;align-items:center;gap:7px;flex-wrap:wrap;justify-content:flex-end;font-size:11px;font-weight:900;color:var(--se-aero-navy)}.se-cs-top-identity span{display:inline}.se-cs-top-identity span+span:before{content:'·';margin-right:7px;color:#8da0b5}.se-cs-top-signout{border:1px solid rgba(18,54,90,.20);border-radius:999px;padding:7px 10px;background:#fff;color:var(--se-aero-navy);font-size:11px;font-weight:900;cursor:pointer}
...
/* COMPONENT-customer-settings-v5.js - END */
