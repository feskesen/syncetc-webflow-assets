/* PAGE-ASSETS-v4.js | live Assets page using shared Assets renderer scoped CSS fix | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-ASSETS-v4";
...
var ROOT_ID="syncetc-assets-v4-root";
...
var RENDERER_URL=window.SYNCETC_ASSETS_RENDERER_URL||"https://feskesen.github.io/syncetc-webflow-assets/COMPONENT-assets-renderer-v2.js";
...
function loadScript(src){
  return new Promise(function(resolve,reject){
    if(window.SYNCETC_ASSETS_RENDERER_V2||window.SYNCETC_ASSETS_RENDERER_V1)return resolve();
...
function boot(){
  ...
  loadScript(RENDERER_URL).then(fetchPageData).then(function(payload){
    var renderer=window.SYNCETC_ASSETS_RENDERER_V2||window.SYNCETC_ASSETS_RENDERER_V1;
