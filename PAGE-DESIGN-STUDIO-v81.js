...
/* PAGE-DESIGN-STUDIO-v81.js | Design Studio 2.1 header alignment patch | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v81";
...
var STYLE_ID="syncetc-design-studio-v81-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V81){
    window.__SYNCETC_DS_ESC_CLOSE_V81=true;
...
window.SYNCETC_V81_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V81,
  ...
  console.log('SYNCETC_V81_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V81_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V81_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V81_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V81_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V81_SCOPE_STATE",out);
  return out;
};
...
window.SYNCETC_V81_STUDIO_STATE=function(){
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V81_STUDIO_STATE",out);
  return out;
};
...
function v81NormalizeDesignStudioHeader(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;
  var link=root.querySelector('a[href="/page-builder"]')||root.querySelector('a[href*="/page-builder"]');
  ...
  var row=root.querySelector(".ds-title-row");
  if(!row){
    ...
    copy.className="ds-title-copy";
    row.appendChild(copy);
    copy.appendChild(heading);
  }

  var copy=row.querySelector(".ds-title-copy");
  if(!copy){
    copy=document.createElement("div");
    copy.className="ds-title-copy";
    row.insertBefore(copy,row.firstChild);
  }
  if(heading.parentElement!==copy)copy.insertBefore(heading,copy.firstChild);

  var note=copy.querySelector(".ds-sample-preview-note");
  if(!note){
    note=document.createElement("div");
    note.className="ds-sample-preview-note";
    note.textContent="Design Studio 2.1: visual layout and design-profile editor. Page creation moves to Page Builder.";
  ...
  link.className="ds-pagebuilder-link";
  link.textContent="Page Builder →";
  link.href="/page-builder";
  if(link.parentElement!==row)row.appendChild(link);
...
/* v81 Design Studio diagnostic - BEGIN */
window.SYNCETC_V81_HEADER_STATE=function(){
  var out={
    version:VERSION,
    pageBuilderLinks:document.querySelectorAll('.ds-pagebuilder-link[href="/page-builder"]').length,
    titleRows:document.querySelectorAll('.ds-title-row').length,
    hasRightHeaderButton:!!document.querySelector('.ds-title-row .ds-pagebuilder-link[href="/page-builder"]')
  };
  console.log("SYNCETC_V81_HEADER_STATE",out);
  return out;
};
/* v81 Design Studio diagnostic - END */

if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start);else start();setTimeout(v81NormalizeDesignStudioHeader,50);setTimeout(v81NormalizeDesignStudioHeader,300);
