/* PAGE-CALENDAR-VIEWER-v8.js - BEGIN */
(function(){
"use strict";
...
function ensureComponents(){var base=componentBaseUrl();return COMPONENT_FILES.reduce(function(p,file){return p.then(function(){return loadScriptOnce(base + file + "?v=calendar-viewer-delay-v8");});},Promise.resolve());}
var VERSION="PAGE-CALENDAR-VIEWER-v8",EDGE_READ_URL="https://ocdaohkiwonjmirqkjww.supabase.co/functions/v1/syncetc-calendar-viewer-read";
...
/* PAGE-CALENDAR-VIEWER-v8.js - END */
