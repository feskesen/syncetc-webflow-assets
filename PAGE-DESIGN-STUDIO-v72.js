...
/* PAGE-DESIGN-STUDIO-v72.js | close button inline guarded exit fix | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v72";
...
var STYLE_ID="syncetc-design-studio-v72-style";
...
/* v72 close semantics - BEGIN */
function v72HasPageSpecificUnsavedWork(){
  return !!(state.sideDirty||state.sideAppliedDirty);
}

function v72CloseSideDrawer(){
  if(v72HasPageSpecificUnsavedWork()){
...
function bindFrame(){
  ...
  r.querySelectorAll('[data-ds-action]').forEach(function(btn){
    btn.addEventListener('click',function(){
      ...
      if(action==='side-close'){v72CloseSideDrawer();return;}
      if(action==='apply-page-text'){applyPageText();return;}
      if(action==='save-page-text'){savePageText();return;}
      if(action==='discard-page-text'){v72CloseSideDrawer();return;}
...
/* v72 removed legacy discard capture fallback */
...
/* v72 close diagnostic - BEGIN */
window.SYNCETC_V72_CLOSE_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    hasUnsaved:v72HasPageSpecificUnsavedWork()
  };
  console.log("SYNCETC_V72_CLOSE_STATE",out);
  return out;
};
/* v72 close diagnostic - END */

installUnsavedGuardsOnce();
/* PAGE-DESIGN-STUDIO-v72.js - END */
