/* PAGE-DESIGN-STUDIO-v11.js | equal top columns and no helper text | Generated: 2026-06-01 06:40:00 UTC */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v11";
...
var STYLE_ID="syncetc-design-studio-v11-style";
...
function installStyles(){
  ...
  style.textContent='\
    ...
    #'+ROOT_ID+' .ds-status{min-height:36px;border:1px solid rgba(18,54,90,.16);border-radius:12px;background:#f8fbff;color:#536171;font-size:11.5px;font-weight:850;line-height:1.15;padding:6px 10px;display:flex;align-items:center;}\
