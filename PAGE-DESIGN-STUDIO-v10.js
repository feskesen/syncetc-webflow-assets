/* PAGE-DESIGN-STUDIO-v10.js | top-row status and true preview isolation | Generated: 2026-06-01 06:25:00 UTC */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v10";
...
var STYLE_ID="syncetc-design-studio-v10-style";
...
function installStyles(){
  ...
  style.textContent='\
    ...
    #'+ROOT_ID+' .ds-profile-grid{display:grid;grid-template-columns:minmax(0,1.25fr) minmax(0,1.25fr) minmax(220px,.7fr);gap:12px;align-items:end;}\
    ...
    #'+ROOT_ID+' .ds-status{min-height:42px;border:1px solid rgba(18,54,90,.16);border-radius:12px;background:#f8fbff;color:#536171;font-size:11.5px;font-weight:850;line-height:1.25;padding:8px 10px;display:flex;align-items:center;}\
    #'+ROOT_ID+' .ds-status.good{color:#166534;}\
    #'+ROOT_ID+' .ds-status.warn{color:#92400e;}\
    #'+ROOT_ID+' .ds-status.error{color:#991b1b;}\
    #'+ROOT_ID+' .ds-actions{display:flex;gap:8px;flex-wrap:nowrap;justify-content:flex-end;align-items:center;width:100%;} #'+ROOT_ID+' .ds-actions .ds-btn{flex:0 0 auto;}\
    #'+ROOT_ID+' .ds-btn{display:inline-flex;align-items:center;justify-content:center;min-height:36px;border:1px solid #12365a;border-radius:999px;background:#12365a;color:#fff;padding:8px 11px;font:inherit;font-size:11.5px;font-weight:950;cursor:pointer;text-decoration:none;white-space:nowrap;}\
