/* COMPONENT-customer-settings-v3.js - BEGIN */
(function(){
"use strict";
window.SyncEtc=window.SyncEtc||{};
window.SyncEtc.Components=window.SyncEtc.Components||{};
var VERSION="COMPONENT-customer-settings-v3";
...
function installStyles(){
  U().installStyle("COMPONENT-customer-settings-v3-style",`
    ...
    .se-customer-settings-toggle{border:1px solid rgba(18,54,90,.20);border-radius:999px;padding:8px 12px;background:#fff;color:var(--se-aero-navy);font-size:12px;font-weight:900;cursor:pointer}
    ...
    @media(max-width:900px){.se-customer-settings-row{grid-template-columns:1fr}.se-cs-identity{grid-template-columns:1fr}.se-cs-signout{justify-self:start}}
  `);
}
...
function render(ctx){
  ...
  return `<section class="se-customer-settings"><div class="se-customer-settings-shell ${open?"is-open":""}" data-se-customer-settings>
    <div class="se-customer-settings-top">
      ...
      <button type="button" class="se-customer-settings-toggle" data-cs-toggle>${open?"Close Customer Settings":"Open Customer Settings"}</button>
    </div>
...
/* COMPONENT-customer-settings-v3.js - END */
