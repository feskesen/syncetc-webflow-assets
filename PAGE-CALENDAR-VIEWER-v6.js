/* PAGE-CALENDAR-VIEWER-v6.js - BEGIN */
(function(){
"use strict";
...
function ensureComponents(){var base=componentBaseUrl();return COMPONENT_FILES.reduce(function(p,file){return p.then(function(){return loadScriptOnce(base + file + "?v=calendar-viewer-startup-freeze-v6");});},Promise.resolve());}
var VERSION="PAGE-CALENDAR-VIEWER-v6",EDGE_READ_URL="https://ocdaohkiwonjmirqkjww.supabase.co/functions/v1/syncetc-calendar-viewer-read";
var state={shell:null,events:[],visibleEvents:[],selectedEvent:null,dateFilter:"upcoming",typeFilter:"all",search:"",loading:true,error:"",lastCustomerKey:"",refreshTimer:null,refreshBusy:false,refreshQueued:false,startupComplete:false,startupFrozen:true,firstRenderDone:false,lastRefreshAt:0};
