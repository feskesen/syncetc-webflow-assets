...
/* PAGE-DESIGN-STUDIO-v77.js | hardened save page settings | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v77";
...
var STYLE_ID="syncetc-design-studio-v77-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V77){
    window.__SYNCETC_DS_ESC_CLOSE_V77=true;
...
window.SYNCETC_V77_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V77,
  ...
  console.log('SYNCETC_V77_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V77_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V77_SAVE_STATE",out);
  return out;
};
