...
/* PAGE-DESIGN-STUDIO-v75.js | wire close x escape for page settings drawer | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v75";
...
var STYLE_ID="syncetc-design-studio-v75-style";
...
/* v75 removed legacy discard function */
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V75){
    window.__SYNCETC_DS_ESC_CLOSE_V75=true;
...
/* v75 removed legacy discard capture fallback */
...
/* v75 close wiring diagnostic - BEGIN */
window.SYNCETC_V75_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V75,
  ...
  console.log('SYNCETC_V75_CLOSE_WIRING_STATE',out);
  return out;
};
/* v75 close wiring diagnostic - END */

/* PAGE-DESIGN-STUDIO-v75.js - END */
