/* PAGE-DESIGN-STUDIO-v36.js | visible inheritance audit panel placement | Generated: 2026-06-01 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v36";
...
var STYLE_ID="syncetc-design-studio-v36-style";
...
function bindFrame(){
  ...
  r.querySelectorAll('[data-ds-action]').forEach(function(btn){
    btn.addEventListener('click',function(){
      ...
      if(action==='side-close'){if(hasSideUnsaved()&&!window.confirm('Discard unapplied/unsaved Page Text changes and close?'))return;state.sideOpen=false;state.sideDirty=false;state.sideAppliedDirty=false;state.sideDraftValues=null;state.sideAppliedValues=null;state.notice='Page Text closed. Inheritance audit active.';renderFrame();return;}
