...
(function () {
  ...
  function installStyles() {
    ...
    U.installStyle("COMPONENT-master-header-v1-style", `
  ...
  function navRows(ctx) {
    ...
    const showMember = audience === "member" || audience === "admin";
    const showAdmin = audience === "admin";
    ...
    return `<div class="club-header-wrapper"><header class="club-header-card">
      ...
      <div class="club-header-main">
        <div class="club-header-top">
          ...
          <div class="club-auth-buttons"><button class="club-auth-btn login">Login</button><button class="club-auth-btn logout">Logout</button></div>
        </div>
  ...
  window.SyncEtc.Components.MasterHeader = { render: render, installStyles: installStyles };
})();
