...
/* PAGE-DESIGN-STUDIO-v83.js | Design Studio 2.1 auth baseline header polish | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v83";
...
var STYLE_ID="syncetc-design-studio-v83-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V83){
    window.__SYNCETC_DS_ESC_CLOSE_V83=true;
...
window.SYNCETC_V83_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V83,
  ...
  console.log('SYNCETC_V83_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V83_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V83_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V83_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V83_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V83_SCOPE_STATE",out);
  return out;
};
...
window.SYNCETC_V83_STUDIO_STATE=function(){
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V83_STUDIO_STATE",out);
  return out;
};
...
function v83NormalizeDesignStudioHeader(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;
  var link=root.querySelector('a.ds-pagebuilder-link[href="/page-builder"]');
  if(!link)return;
...
/* v83 Design Studio header/auth diagnostic - BEGIN */
window.SYNCETC_V83_HEADER_STATE=function(){
  var link=document.querySelector('.ds-pagebuilder-link[href="/page-builder"]');
  var out={
    version:VERSION,
    pageBuilderPillLinks:document.querySelectorAll('.ds-pagebuilder-link[href="/page-builder"]').length,
    linkDisplay:link?getComputedStyle(link).display:"",
    linkBorderRadius:link?getComputedStyle(link).borderRadius:"",
    authTokenPresent:!!getToken(),
    authEmail:state.authEmail||""
  };
  console.log("SYNCETC_V83_HEADER_STATE",out);
  return out;
};
/* v83 Design Studio header/auth diagnostic - END */

if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start);else start();setTimeout(v83NormalizeDesignStudioHeader,50);setTimeout(v83NormalizeDesignStudioHeader,300);setTimeout(v83NormalizeDesignStudioHeader,900);
