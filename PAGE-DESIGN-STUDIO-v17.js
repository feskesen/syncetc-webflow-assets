/* PAGE-DESIGN-STUDIO-v17.js | bind status sign-in button after render | Generated: 2026-06-01 10:10:00 UTC */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v17";
...
var STYLE_ID="syncetc-design-studio-v17-style";
  ...
  r.querySelectorAll('[data-ds-action]').forEach(function(btn){
    btn.addEventListener('click',function(){
      ...
      if(action==='toggle-auth'){
        ...
        state.authOpen=!state.authOpen;renderFrame();return;
      }
