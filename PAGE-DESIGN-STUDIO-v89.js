...
/* PAGE-DESIGN-STUDIO-v89.js | Shared header optical alignment | Generated: 2026-06-03 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v89";
...
var STYLE_ID="syncetc-design-studio-v89-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V89){
    window.__SYNCETC_DS_ESC_CLOSE_V89=true;
...
window.SYNCETC_V89_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V89,
  ...
  console.log('SYNCETC_V89_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V89_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V89_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V89_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V89_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V89_SCOPE_STATE",out);
  return out;
};
...
window.SYNCETC_V89_STUDIO_STATE=function(){
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V89_STUDIO_STATE",out);
  return out;
};
...
function v89NormalizeDesignStudioHeader(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;
  var existing=root.querySelector(".syncetc-tool-header");
  if(existing)return;
  var wrap=document.createElement("div");
  wrap.innerHTML=renderToolHeaderShared("layout-designer","Layout Designer");
  var header=wrap.firstChild;
  var first=root.firstElementChild;
  if(first)root.insertBefore(header,first);else root.appendChild(header);
  [].slice.call(root.querySelectorAll('a[href="/page-builder"],a[href="/customer-manager"],a[href="/syncetc-landing-page"]')).forEach(function(a){
    if(!a.closest(".syncetc-tool-header"))a.remove();
  });
}
...
function v89InstallPlatformToolRow(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;
  v89NormalizeDesignStudioHeader();
}
/* v85 platform tool row - END */


/* v85 Design Studio diagnostic - BEGIN */
window.SYNCETC_V89_TOOL_STATE=function(){
  var out={
    version:VERSION,
    ...
    platformRows:document.querySelectorAll('.ds-v89-platform-row').length,
    authTokenPresent:!!getToken(),
    authEmail:state.authEmail||""
  };
  console.log("SYNCETC_V89_TOOL_STATE",out);
  return out;
};
/* v85 Design Studio diagnostic - END */

if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start);else start();setTimeout(v89NormalizeDesignStudioHeader,50);setTimeout(v89NormalizeDesignStudioHeader,300);setTimeout(v89InstallPlatformToolRow,80);setTimeout(v89InstallPlatformToolRow,350);
