/* COMPONENT-auth-context-v1B.js - BEGIN */
(function () {
  "use strict";

  window.SyncEtc = window.SyncEtc || {};

  var VERSION = "COMPONENT-auth-context-v1B";
  ...
  function selectedCustomerKey() {
    try { return clean(window.localStorage.getItem(STORAGE_KEY_ACTIVE_CUSTOMER)); }
    catch (_err) { return ""; }
  }
  ...
  function getSnapshot() {
    ...
    return {
      ...
      selected_customer_key: selectedCustomerKey(),
...
/* COMPONENT-auth-context-v1B.js - END */
