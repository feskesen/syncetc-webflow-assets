...
/* PAGE-DESIGN-STUDIO-v76.js | clean tail and close x escape wiring | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v76";
...
var STYLE_ID="syncetc-design-studio-v76-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V76){
    window.__SYNCETC_DS_ESC_CLOSE_V76=true;
...
window.SYNCETC_V76_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V76,
  ...
  console.log('SYNCETC_V76_CLOSE_WIRING_STATE',out);
  return out;
};
