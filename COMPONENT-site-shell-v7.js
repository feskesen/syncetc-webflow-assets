...
(function () {
  ...
  function create(mountId,options){
    var state=Object.assign({customerKey:"demo_flying_club",customerName:"Demo Flying Club",pageKey:"events",audience:"public",viewAs:"public",showControls:true,showBanner:false,siteEditorOpen:false,customerSettingsOpen:false,local:{},version:VERSION},options||{});
    ...
    function setCustomerSettingsOpen(value){state.customerSettingsOpen=!!value;}
    ...
    var api={render:render,customer:customer,loadCustomer:loadCustomer,getState:getState,setLocal:setLocal,setViewAs:setViewAs,setCustomerKey:setCustomerKey,setEditorOpen:setEditorOpen,setCustomerSettingsOpen:setCustomerSettingsOpen,getSavePayload:getSavePayload};
    return api;
  }
  window.SyncEtc.Components.SiteShell={create:create,version:VERSION};
})();
/* COMPONENT-site-shell-v7.js - END */
