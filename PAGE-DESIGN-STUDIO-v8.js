/* PAGE-DESIGN-STUDIO-v8.js | remove live preview row and correct full-screen action | Generated: 2026-06-01 05:15:00 UTC */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v8";
...
var STYLE_ID="syncetc-design-studio-v8-style";
...
function installStyles(){
  ...
  style.textContent='\
    ...
    #'+ROOT_ID+' .ds-profile-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:12px;align-items:end;}\
    ...
    @media(max-width:760px){#'+ROOT_ID+' .ds-shell{padding:18px 14px 48px;}#'+ROOT_ID+' .ds-hero-top{display:block;}#'+ROOT_ID+' .ds-version{margin-top:12px;}#'+ROOT_ID+' .ds-profile-grid,#'+ROOT_ID+' .ds-toolbar-grid,#'+ROOT_ID+' .ds-layout-grid,#'+ROOT_ID+' .ds-effect-grid,#'+ROOT_ID+' .ds-extra-grid{grid-template-columns:1fr;}#'+ROOT_ID+'{--ds-control-h:1560px;}#'+ROOT_ID+' .ds-toolbar-actions{display:block;}#'+ROOT_ID+' .ds-actions{justify-content:flex-start;margin-top:10px;}#'+ROOT_ID+' .ds-preview-head{display:block;}#'+ROOT_ID+' .ds-chip-row{justify-content:flex-start;margin-top:10px;}#'+ROOT_ID+' .ds-preview-header{grid-template-columns:1fr;}#'+ROOT_ID+' .ds-grid{grid-template-columns:1fr!important;}}\
  ';
...
function syncSelectedFromSettings(){
  ...
  state.selected.imageTreatment="standard";
  state.selected.dividerStyle="hairline";
  state.selected.emphasisStyle="pills";
  state.selected.surfaceStyle="cards";
  ...
  mount.innerHTML='<div id="'+ROOT_ID+'" class="'+(state.loading?'ds-skeleton':'')+'">'+
    '<div class="ds-shell">'+
      ...
      '<div class="ds-toolbar-wrap"><section class="ds-toolbar" aria-label="Design Studio Controls">'+
        ...
        '</div>'+
        '<div class="ds-toolbar-actions"><div class="ds-status" data-ds-status></div><div class="ds-actions"><button class="ds-btn" type="button" data-ds-action="save">Save to customer</button><button class="ds-btn secondary" type="button" data-ds-action="save-profile" disabled>Save as New Design Profile</button><button class="ds-btn secondary" type="button" data-ds-action="enter-profile" disabled>Enter New Design Profile</button><button class="ds-btn secondary" type="button" data-ds-action="reset">Discard Preview Changes</button><button class="ds-btn secondary" type="button" data-ds-action="reload">Reload from Supabase</button></div></div>'+
      '</section></div>'+
