/* PAGE-EVENT-RSVP-v7.js - BEGIN */
(function(){
"use strict";

var VERSION="PAGE-EVENT-RSVP-v7";
...
function scriptBase(){
  ...
  for(var i=scripts.length-1;i>=0;i--){
    ...
    if(src.indexOf("PAGE-EVENT-RSVP-v7.js")>-1){
...
function loadComponents(){
  ...
  COMPONENT_FILES.forEach(function(file){
    p=p.then(function(){return loadScript(base+file+"?v=event-rsvp-v7");});
  });
  return p;
}
...
function styleHtml(){
  return '<style id="PAGE-EVENT-RSVP-v7-style">'+
