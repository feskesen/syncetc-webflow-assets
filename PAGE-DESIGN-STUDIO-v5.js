/* PAGE-DESIGN-STUDIO-v5.js | design profile row, motion, and background controls | Generated: 2026-06-01 04:05:00 UTC */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v5";
...
var STYLE_ID="syncetc-design-studio-v5-style";
var CONTROL_ORDER=["customer","designProfile","layout","style","typography","color","effect","siteWidth","headerTreatment","heroTreatment","sectionRhythm","density","shadow","border","corner","gradient","motion","background"];
...
var DESIGN_PROFILE_RECIPES={
  "classic-aviation-club":{
    ...
    shadow:"preset",border:"preset",corner:"preset",gradient:"preset",siteWidth:"standard",headerTreatment:"standard",heroTreatment:"banner",sectionRhythm:"standard",density:"standard",motion:"subtle",background:"soft-tint"
  },
  "plain-jane-open":{
    layout:"apple-unboxed",style:"minimal-plain",typography:"apple-system-large",color:"plain-black-white",effect:"flat-no-chrome",
    shadow:"none",border:"none",corner:"square",gradient:"off",siteWidth:"narrow",headerTreatment:"plain",heroTreatment:"plain",sectionRhythm:"open",density:"relaxed",motion:"none",background:"pure-white"
  },
  "forest-ops-dashboard":{
    ...
    shadow:"minimal",border:"hairline",corner:"soft",gradient:"subtle",siteWidth:"wide",headerTreatment:"dashboard",heroTreatment:"compact",sectionRhythm:"divided",density:"operations",motion:"none",background:"soft-tint"
  },
  "modern-utility":{
    ...
    shadow:"minimal",border:"hairline",corner:"soft",gradient:"subtle",siteWidth:"standard",headerTreatment:"utility",heroTreatment:"compact",sectionRhythm:"divided",density:"compact",motion:"subtle",background:"pure-white"
  },
  "premium-editorial":{
    ...
    shadow:"soft",border:"hairline",corner:"rounded",gradient:"subtle",siteWidth:"wide",headerTreatment:"plain",heroTreatment:"banner",sectionRhythm:"open",density:"relaxed",motion:"polished",background:"gradient-wash"
  }
};
...
function installStyles(){
  ...
  style.textContent='\
    ...
    #'+ROOT_ID+'{--ds-shell-max:1240px;--ds-sticky-top:0px;--ds-control-h:352px;--ds-primary:#12365a;--ds-accent:#2f80c4;--ds-soft:#eaf5ff;--ds-text:#17212b;--ds-muted:#5d6b78;--ds-bg:#fff;--ds-font:Arial,Helvetica,sans-serif;--ds-radius:22px;--ds-button-radius:999px;--ds-eyebrow-radius:999px;--ds-gap:18px;--ds-shadow:0 10px 28px rgba(12,38,64,.10);--ds-border:1px solid rgba(18,54,90,.14);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;color:#17212b;min-height:100vh;background:linear-gradient(180deg,#f7fbff 0%,#ffffff 220px);}\
    ...
    #'+ROOT_ID+' .ds-profile-grid{display:grid;grid-template-columns:minmax(280px,1fr) minmax(420px,2fr);gap:10px;align-items:end;}\
    ...
    @media(max-width:1080px){#'+ROOT_ID+' .ds-profile-grid,#'+ROOT_ID+' .ds-toolbar-grid,#'+ROOT_ID+' .ds-layout-grid,#'+ROOT_ID+' .ds-effect-grid,#'+ROOT_ID+' .ds-extra-grid{grid-template-columns:1fr 1fr;}#'+ROOT_ID+'{--ds-control-h:620px;}}\
    @media(max-width:760px){#'+ROOT_ID+' .ds-shell{padding:18px 14px 48px;}#'+ROOT_ID+' .ds-hero-top{display:block;}#'+ROOT_ID+' .ds-version{margin-top:12px;}#'+ROOT_ID+' .ds-profile-grid,#'+ROOT_ID+' .ds-toolbar-grid,#'+ROOT_ID+' .ds-layout-grid,#'+ROOT_ID+' .ds-effect-grid,#'+ROOT_ID+' .ds-extra-grid{grid-template-columns:1fr;}#'+ROOT_ID+'{--ds-control-h:1240px;}#'+ROOT_ID+' .ds-toolbar-actions{display:block;}#'+ROOT_ID+' .ds-actions{justify-content:flex-start;margin-top:10px;}#'+ROOT_ID+' .ds-preview-head{display:block;}#'+ROOT_ID+' .ds-chip-row{justify-content:flex-start;margin-top:10px;}#'+ROOT_ID+' .ds-preview-header{grid-template-columns:1fr;}#'+ROOT_ID+' .ds-grid{grid-template-columns:1fr!important;}}\
  ';
...
function syncSelectedFromSettings(){
  ...
  state.selected.motion="subtle";
  state.selected.background="pure-white";
...
function designProfileOptionsHtml(){
  return DESIGN_PROFILE_OPTIONS.map(function(p){return '<option value="'+esc(p.key)+'" '+(p.key===state.selected.designProfile?'selected':'')+'>'+esc(p.label)+'</option>';}).join("");
}
...
function designProfileHelp(){
  ...
  return "Saved design profiles will be Supabase-backed after the profile schema is added.";
}

function applyDesignProfile(profileKey){
  var recipe=DESIGN_PROFILE_RECIPES[profileKey];
