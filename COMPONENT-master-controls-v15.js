...
function installStyles(){U().installStyle("COMPONENT-master-controls-v15-style",`
    ...
    .se-body{display:block;padding:0;background:transparent}
    .se-note{margin:0 0 14px;color:#64748b;font-size:12px;line-height:1.45;font-weight:700}
    .se-row{display:grid;grid-template-columns:1fr;gap:10px;margin-bottom:10px}
    .se-control{display:block}
    .se-control span{display:block;margin-bottom:5px;color:#12365a;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.03em}
    .se-control small{display:block;margin-top:4px;color:#64748b;font-size:11px}
    .se-control input,.se-control select,.se-control textarea{width:100%;border:1px solid rgba(18,54,90,.20);border-radius:11px;padding:9px 10px;background:#fff;color:#102034;font:inherit;font-size:13px}
    .se-control textarea{min-height:78px;resize:vertical}
    .se-view-row{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:8px 0 12px}
    .se-view-row button,.se-save{border:1px solid rgba(18,54,90,.20);border-radius:999px;padding:9px 10px;background:#fff;color:#12365a;font-weight:900;font-size:12px;cursor:pointer}
    .se-view-row button.is-active,.se-save{background:#12365a;color:#fff;border-color:#12365a}
    .se-preview{display:grid;grid-template-columns:1fr;gap:10px;margin-top:10px}
    .se-preview-card{border:1px solid rgba(18,54,90,.14);border-radius:14px;padding:12px;background:#fff}
    .se-preview-card h4{margin:0 0 4px;color:#12365a;font-size:14px}
    .se-preview-card p{margin:0;color:#64748b;font-size:12px;line-height:1.35}
    .se-preview-pills{display:flex;gap:6px;flex-wrap:wrap;margin-top:8px}
    .se-preview-pills span{font-size:10.5px;font-weight:900;color:#12365a}
...
/* COMPONENT-master-controls-v15.js - END */
