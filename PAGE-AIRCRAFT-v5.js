/* PAGE-AIRCRAFT-v5.js - BEGIN */
(function () {
  "use strict";

  const VERSION = "PAGE-AIRCRAFT-v5";
  const MOUNT_ID = "syncetc-webflow-mount";
  const STYLE_ID = "syncetc-aircraft-page-v5-style";
  ...
  const COMPONENT_FILES = [
    ...
    "COMPONENT-customer-settings-v2.js",
    "COMPONENT-master-header-v3.js",
  ...
  function ensureComponents() {
    ...
    return COMPONENT_FILES.reduce(function(p, file) {
      return p.then(function() {
        return loadScriptOnce(base + file + "?v=page-aware-customer-settings-aircraft-5");
      });
    }, Promise.resolve());
  }
