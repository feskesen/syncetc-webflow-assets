/* PAGE-ASSETS-v2.js | self-contained consumer of saved Assets page text | Generated: 2026-06-01 */
(function(){
"use strict";
var VERSION="PAGE-ASSETS-v2";
...
var ROOT_ID="syncetc-assets-v1-root";
var STYLE_ID="syncetc-assets-v1-style";
...
function getSyncEtcConfig(){
  return {
    env:String(window.SYNCETC_ENV||"production").trim(),
    customerKey:String(window.SYNCETC_CUSTOMER_KEY||window.SYNCETC_ACTIVE_CUSTOMER_KEY||"").trim(),
    customerName:String(window.SYNCETC_CUSTOMER_NAME||window.SYNCETC_ACTIVE_CUSTOMER_NAME||"").trim(),
    pageKey:String(window.SYNCETC_PAGE_KEY||"assets").trim(),
    hostname:String(window.location&&window.location.hostname||"").trim()
  };
}

function customerNameFromKey(key){
  var map={"150th-aero":"150th Aero Flying Club","demo_flying_club":"150th Aero Flying Club","test-customer":"Test Customer","test_customer":"Test Customer"};
  return map[key]||"";
}

function getCustomerName(){
  var cfg=getSyncEtcConfig();
  return cfg.customerName||customerNameFromKey(cfg.customerKey)||"150th Aero Flying Club";
}

function getCustomerKey(){
  var cfg=getSyncEtcConfig();
  return cfg.customerKey||"150th-aero";
}
