/* PAGE-CALENDAR-VIEWER-v7.js - BEGIN */
(function(){
"use strict";
...
function ensureComponents(){var base=componentBaseUrl();return COMPONENT_FILES.reduce(function(p,file){return p.then(function(){return loadScriptOnce(base + file + "?v=calendar-viewer-initial-fetch-v7");});},Promise.resolve());}
var VERSION="PAGE-CALENDAR-VIEWER-v7",EDGE_READ_URL="https://ocdaohkiwonjmirqkjww.supabase.co/functions/v1/syncetc-calendar-viewer-read";
var state={shell:null,events:[],visibleEvents:[],selectedEvent:null,dateFilter:"upcoming",typeFilter:"all",search:"",loading:true,error:"",lastCustomerKey:"",refreshTimer:null,refreshBusy:false,refreshQueued:false,startupComplete:false,startupFrozen:true,firstRenderDone:false,initialFetchDone:false,initialFallbackTimer:null,lastRefreshAt:0};
...
function initialCalendarLoad(){
  ...
  state.initialFallbackTimer=setTimeout(function(){
  ...
  return fetchData().then(function(){
    state.initialFetchDone=true;
    if(state.initialFallbackTimer){clearTimeout(state.initialFallbackTimer);state.initialFallbackTimer=null;}
  }).catch(function(){
    state.initialFetchDone=true;
    if(state.initialFallbackTimer){clearTimeout(state.initialFallbackTimer);state.initialFallbackTimer=null;}
  });
...
/* PAGE-CALENDAR-VIEWER-v7.js - END */
