/* PAGE-DESIGN-STUDIO-v25.js | page text preview layout and live field wiring | Generated: 2026-06-01 13:35:00 UTC */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v25";
...
var STYLE_ID="syncetc-design-studio-v25-style";
...
function installStyles(){
  ...
  style.textContent='\
    ...
    /* v25 page text mode layout */\
    #'+ROOT_ID+'.ds-page-text-mode .ds-toolbar-wrap{max-height:112px;overflow:hidden;opacity:.72;}\
    #'+ROOT_ID+'.ds-page-text-mode .ds-toolbar-grid,#'+ROOT_ID+'.ds-page-text-mode .ds-layout-grid,#'+ROOT_ID+'.ds-page-text-mode .ds-effect-grid,#'+ROOT_ID+'.ds-page-text-mode .ds-extra-grid{display:none!important;}\
    #'+ROOT_ID+'.ds-page-text-mode .ds-toolbar-actions{display:none!important;}\
    #'+ROOT_ID+'.ds-page-text-mode .ds-preview-outer{margin-right:380px!important;}\
...
function renderSelectedPagePreview(){
  ...
  var intro=fieldValue(settings,"hero_intro","Page text preview for "+label+".");
