/* COMPONENT-master-header-v2.js - BEGIN */
(function () {
  "use strict";
  ...
  var VERSION = "COMPONENT-master-header-v2";
  var wired = false;

  function installStyles() {
    const U = window.SyncEtc.Components.Utils;
    U.installStyle("COMPONENT-master-header-v2-style", `
...
/* COMPONENT-master-header-v2.js - END */
