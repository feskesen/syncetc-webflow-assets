/* COMPONENT-syncetc-tool-header-v2.js | Shared SyncEtc tool header renderer | Generated: 2026-06-03 */
(function(){
  "use strict";
  ...
  function render(options){
    ...
    var title=clean(options.title||"Hub");
    var eyebrow=clean(options.eyebrow||"SYNCETC COMPANY TOOL");
    var description=clean(options.description||"Company tools portal.");
    var logo=clean(options.logoUrl||LOGO_URL);

    return '<section class="syncetc-tool-header">'
      + '<div class="syncetc-tool-header-main">'
      + '<div class="syncetc-tool-header-brandline"><img class="syncetc-tool-header-logo" src="'+esc(logo)+'" alt="SyncEtc"><h1 class="syncetc-tool-header-title">'+esc(title)+'</h1></div>'
      + '<div class="syncetc-tool-header-eyebrow">'+esc(eyebrow)+'</div>'
      + '<p class="syncetc-tool-header-description">'+esc(description)+'</p>'
      + '</div>'
...
/* COMPONENT-syncetc-tool-header-v2.js - END */
