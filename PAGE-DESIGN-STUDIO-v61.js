...
/* PAGE-DESIGN-STUDIO-v61.js | fix Assets save page_key alignment | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v61";
...
var STYLE_ID="syncetc-design-studio-v61-style";
...
function valuesForSharedAssetsRenderer(records){
  ...
  var savedValues=livePageTextValues ? livePageTextValues() : {};
  var appliedValues=state.sideAppliedValues||{};
  var vals=Object.assign({},loadedBridge,savedValues,appliedValues);
...
window.SYNCETC_PAGE_SETTINGS_SAVE_STATE=function(){
  var out={
    ...
    save_page_key:canonicalPageKeyForSettingsSave(currentPreviewPageKeyForSave(),state.sideAppliedValues||collectPageTextValues(),currentPreviewPageLabelForSave()),
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    sideSaving:state.sideSaving
  };
