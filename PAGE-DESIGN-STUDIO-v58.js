...
/* PAGE-DESIGN-STUDIO-v58.js | save page settings to Supabase | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v58";
...
var STYLE_ID="syncetc-design-studio-v58-style";
...
function pageSettingsSavePayload(values,fields,row,key,label){
  ...
  var saveKey=normalizePageKeyForSave(key);
  return {
...
window.SYNCETC_PAGE_SETTINGS_SAVE_STATE=function(){
  var out={
    ...
    save_page_key:normalizePageKeyForSave(selectedPageKey()),
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    sideSaving:state.sideSaving
  };
