/* PAGE-DESIGN-STUDIO-v28.js | actual Aircraft v3 preview and exact page text keys | Generated: 2026-06-01 14:55:00 UTC */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v28";
...
var STYLE_ID="syncetc-design-studio-v28-style";
...
/* v28 actual Aircraft v3 CSS source - BEGIN */
...
/* v28 actual Aircraft v3 CSS source - END */
...
function renderActualAircraftPagePreview(){
  ...
  return '<div class="aero-fleet-page"><div class="aero-fleet-shell">'+
    ...
    '<main class="aero-fleet-main">'+
      ...
      '</section>'+
      '<section class="aero-aircraft-list">'+(rows.length?rows.map(function(){return '';}).join(''):'<div class="aero-empty-message">Aircraft information is not available at this time.</div>')+'</section>'+
