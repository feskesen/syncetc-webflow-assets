...
/* PAGE-DESIGN-STUDIO-v84.js | Design Studio 2.1 header button placement patch | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v84";
...
var STYLE_ID="syncetc-design-studio-v84-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V84){
    window.__SYNCETC_DS_ESC_CLOSE_V84=true;
...
window.SYNCETC_V84_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V84,
  ...
  console.log('SYNCETC_V84_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V84_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V84_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V84_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V84_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V84_SCOPE_STATE",out);
  return out;
};
...
window.SYNCETC_V84_STUDIO_STATE=function(){
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V84_STUDIO_STATE",out);
  return out;
};
...
function v84NormalizeDesignStudioHeader(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;

  var version=root.querySelector(".ds-version");
  var link=root.querySelector('a.ds-pagebuilder-link[href="/page-builder"]')||root.querySelector('a[href="/page-builder"]');
  if(!link){
    link=document.createElement("a");
    link.href="/page-builder";
    link.textContent="Page Builder →";
  }

  link.className="ds-pagebuilder-link ds-v84-pagebuilder-pill";
  link.textContent="Page Builder →";
  link.href="/page-builder";
  link.setAttribute("style","display:inline-flex;align-items:center;justify-content:center;gap:8px;border:1px solid rgba(11,31,51,.18);border-radius:999px;padding:10px 14px;background:#fff;color:#0b1f33;text-decoration:none;font-weight:900;font-size:13px;box-shadow:0 8px 20px rgba(11,31,51,.08);white-space:nowrap;line-height:1;margin-right:10px;");
  ...
  if(version&&version.parentElement){
    ...
    bar.style.gap="10px";
    if(link.parentElement!==bar)bar.insertBefore(link,version);
  }else{
  ...
  [].slice.call(root.querySelectorAll('a[href="/page-builder"]')).forEach(function(a){
    if(a!==link)a.remove();
  });
}
...
/* v84 Design Studio header diagnostic - BEGIN */
window.SYNCETC_V84_HEADER_STATE=function(){
  var link=document.querySelector('.ds-v84-pagebuilder-pill[href="/page-builder"]');
  var version=document.querySelector('.ds-version');
  var out={
    version:VERSION,
    pageBuilderPillLinks:document.querySelectorAll('.ds-v84-pagebuilder-pill[href="/page-builder"]').length,
    sharesVersionParent:!!(link&&version&&link.parentElement===version.parentElement),
    linkDisplay:link?getComputedStyle(link).display:"",
    authTokenPresent:!!getToken(),
    authEmail:state.authEmail||""
  };
  console.log("SYNCETC_V84_HEADER_STATE",out);
  return out;
};
/* v84 Design Studio header diagnostic - END */

if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start);else start();setTimeout(v84NormalizeDesignStudioHeader,50);setTimeout(v84NormalizeDesignStudioHeader,300);setTimeout(v84NormalizeDesignStudioHeader,900);
