...
/* PAGE-DESIGN-STUDIO-v49.js | real data bridge and locked page registry | Generated: 2026-06-01 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v49";
...
var STYLE_ID="syncetc-design-studio-v49-style";
...
function loadCurrentPageBridge(){
  if(!getToken||!getToken())return Promise.resolve(null);
...
function bridgeStatusFailHtml(){
  ...
  if(state.pageBridgeError){
    return pageDataFailHtml(
      ...
      "The page registry is working, but Design Studio could not load real page settings/records from the Supabase Edge Function.",
      state.pageBridgeError
    );
  }
  return "";
