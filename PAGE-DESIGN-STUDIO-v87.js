...
/* v42 Info page field registry for Page Specific Settings - BEGIN */


var SYNCETC_INFO_PAGE_DEFAULTS_DEPRECATED_DO_NOT_USE_DEPRECATED_DO_NOT_USE={
  ...
  "sections.0.label":"Our History",
  "sections.0.title":"A long-running New Jersey flying club",
  "sections.0.body.0":"The 150th Aero Flying Club was founded in 1960 by a group of general aviation pilots affiliated with the 150th Air National Guard.",
  "sections.0.body.1":"The Club now operates from Morristown Municipal Airport and Somerset Airport.",
  "sections.1.label":"Membership",
  "sections.1.title":"Shared aircraft, shared responsibility",
  "sections.1.body.0":"Membership in the Club is open to certificated pilots holding at least a private pilot certificate.",
  "sections.1.body.1":"Members are expected to operate within FAA requirements, Club rules, and practical safety expectations.",
  boardLabel:"Board & Officers",
  boardTitle:"Current club officers",
  boardIntro:"The Club is governed by a volunteer Board of Directors, made up of elected Club officers.",
  faqLabel:"FAQs",
  faqTitle:"Frequently Asked Questions",
  faqIntro:"Common questions about membership, costs, aircraft use, training expectations, and the application process.",
...
var SYNCETC_CUSTOMER_CONTEXT_MODEL={
  note:"Customer-facing pages should receive SYNCETC_CUSTOMER_KEY and SYNCETC_PAGE_KEY from their host page or resolve customer by verified domain later.",
  default_customer_key:"150th-aero",
  default_env:"production"
};



var SYNCETC_PAGE_SCRIPT_MAP={
  assets:"PAGE-ASSETS-v2.js",
  info:"PAGE-INFO-v3.js"
};
window.SYNCETC_PAGE_FIELD_REGISTRY = window.SYNCETC_PAGE_FIELD_REGISTRY || {};
window.SYNCETC_PAGE_FIELD_REGISTRY.info = [
...
/* v42 Info page field registry for Page Specific Settings - END */

/* PAGE-DESIGN-STUDIO-v87.js | Hub navigation alignment | Generated: 2026-06-03 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v87";
...
var PAGE_READ_FUNCTION_NAME="syncetc-design-studio-page-read";
function pageReadUrl(){
  var base=String(window.SYNCETC_SUPABASE_URL||"https://ocdaohkiwonjmirqkjww.supabase.co").replace(/\/$/,"");
  return base+"/functions/v1/"+PAGE_READ_FUNCTION_NAME;
}
...
var STYLE_ID="syncetc-design-studio-v87-style";
...
var PAGE_ACCESS_SCOPES=[
  {key:"public",label:"Public page",note:"Visible without login."},
  {key:"member",label:"Member / private page",note:"For authenticated customer members or private users."},
  {key:"user",label:"User dashboard page",note:"For a signed-in user's own portal/dashboard context."},
  {key:"committee",label:"Committee page",note:"For customer committee or workgroup context."},
  {key:"board",label:"Board page",note:"For board/governance context."},
  {key:"admin",label:"Customer admin page",note:"For customer administrators and managers."},
  {key:"platform",label:"Platform-only page",note:"For SyncEtc internal build/support tools."}
];
...
var state={
  ...
  pageBridge:null,
  pageBridgeLoading:false,
  pageBridgeError:"",
  pageBridgeRequestedFor:"",
  assetsRendererRequested:false,
  assetsRendererError:""
};

/* v46 customer/page registry stabilization - BEGIN */
var SYNCETC_CUSTOMER_REGISTRY={
  "150th-aero":{
    customer_key:"150th-aero",
    customer_name:"150th Aero Flying Club",
    display_label:"150th Aero Flying Club",
    enabled_pages:["assets","info"],
    available_pages:["assets","info","calendar","gallery","documents","roster","dashboard","admin"],
    default_page:"assets",
    default_access_scope:"public",
    legacy_customer_names:["150th Aero Flying Club","150th_aero","150th-aero","150thaero"]
  },
  "demo_flying_club":{
    customer_key:"demo_flying_club",
    customer_name:"Demo Flying Club",
    display_label:"Demo Flying Club",
    enabled_pages:["assets","info"],
    available_pages:["assets","info","calendar","gallery","documents","roster","dashboard","admin"],
    default_page:"assets",
    default_access_scope:"public",
    legacy_customer_names:["Demo Flying Club","demo-flying-club","demo_flying_club","demoflyingclub","demo-club","demo_club"]
  },
  "test-customer":{
    customer_key:"test-customer",
    customer_name:"Test Customer",
    display_label:"Test Customer",
    enabled_pages:["assets","info"],
    available_pages:["assets","info","calendar","gallery","documents","roster","dashboard","admin"],
    default_page:"info",
    default_access_scope:"public",
    legacy_customer_names:["Test Customer","test_customer"]
  }
};

var SYNCETC_PAGE_REGISTRY={
  assets:{
    page_key:"assets",
    label:"Assets",
    script_file:"PAGE-ASSETS-v2.js",
    settings_namespace:"assets",
    legacy_namespace_aliases:["aircraft"],
    default_access_scope:"public",
    renderer_name:"assets",
    required_renderer:"renderAssetsPreviewForDesignStudio",
    field_registry_key:"assets"
  },
  info:{
    page_key:"info",
    label:"Info / About",
    script_file:"PAGE-INFO-v3.js",
    settings_namespace:"info",
    legacy_namespace_aliases:[],
    default_access_scope:"public",
    renderer_name:"info",
    required_renderer:"renderInfoPreviewForDesignStudio",
    field_registry_key:"info"
  },
  calendar:{page_key:"calendar",label:"Calendar",script_file:"PAGE-CALENDAR-vNext.js",settings_namespace:"calendar",legacy_namespace_aliases:[],default_access_scope:"public",renderer_name:"calendar",required_renderer:"",field_registry_key:"calendar",conceptual:true},
  gallery:{page_key:"gallery",label:"Gallery",script_file:"PAGE-GALLERY-vNext.js",settings_namespace:"gallery",legacy_namespace_aliases:[],default_access_scope:"member",renderer_name:"gallery",required_renderer:"",field_registry_key:"gallery",conceptual:true},
  documents:{page_key:"documents",label:"Documents",script_file:"PAGE-DOCUMENTS-vNext.js",settings_namespace:"documents",legacy_namespace_aliases:[],default_access_scope:"member",renderer_name:"documents",required_renderer:"",field_registry_key:"documents",conceptual:true},
  roster:{page_key:"roster",label:"Roster",script_file:"PAGE-ROSTER-vNext.js",settings_namespace:"roster",legacy_namespace_aliases:[],default_access_scope:"member",renderer_name:"roster",required_renderer:"",field_registry_key:"roster",conceptual:true},
  dashboard:{page_key:"dashboard",label:"Dashboard",script_file:"PAGE-DASHBOARD-vNext.js",settings_namespace:"dashboard",legacy_namespace_aliases:[],default_access_scope:"user",renderer_name:"dashboard",required_renderer:"",field_registry_key:"dashboard",conceptual:true},
  admin:{page_key:"admin",label:"Admin",script_file:"PAGE-ADMIN-vNext.js",settings_namespace:"admin",legacy_namespace_aliases:[],default_access_scope:"admin",renderer_name:"admin",required_renderer:"",field_registry_key:"admin",conceptual:true}
};

function normalizeCustomerKey(value){
  var v=clean(value||"");
  if(!v)return "150th-aero";

  var canonical=v.toLowerCase()
    .replace(/[\s_]+/g,"-")
    .replace(/[^a-z0-9-]/g,"")
    .replace(/-+/g,"-")
    .replace(/^-|-$/g,"");
  ...
  for(var d=0;d<directCandidates.length;d++){
    if(SYNCETC_CUSTOMER_REGISTRY[directCandidates[d]])return directCandidates[d];
  }

  var keys=Object.keys(SYNCETC_CUSTOMER_REGISTRY);
  for(var i=0;i<keys.length;i++){
    var row=SYNCETC_CUSTOMER_REGISTRY[keys[i]];
    var aliases=[row.customer_key,row.customer_name,row.display_label].concat(row.legacy_customer_names||[]);
    for(var j=0;j<aliases.length;j++){
      var a=clean(aliases[j]||"");
      var ac=a.toLowerCase()
        .replace(/[\s_]+/g,"-")
        .replace(/[^a-z0-9-]/g,"")
        .replace(/-+/g,"-")
        .replace(/^-|-$/g,"");
      if(a===v || ac===canonical || ac.replace(/-/g,"")===canonical.replace(/-/g,""))return keys[i];
    }
  }
...
function activeCustomerContext(){
  if(typeof state==="undefined"||!state)return {missing:true,customer_key:"state-missing",customer_name:"state-missing",enabled_pages:[],default_page:"",default_access_scope:"public"};
  var raw=window.SYNCETC_CUSTOMER_KEY||window.SYNCETC_ACTIVE_CUSTOMER_KEY||state.customer_key||state.customerKey||state.customer||state.customerName||"150th-aero";
  var key=normalizeCustomerKey(raw);
  var row=SYNCETC_CUSTOMER_REGISTRY[key];
  if(!row){
    return {missing:true,customer_key:key,customer_name:key,enabled_pages:[],default_page:"",default_access_scope:"public"};
  }
  return row;
}

function activePageRegistry(){
  var ctx=activeCustomerContext();
  var page=clean(state.sidePageKey||ctx.default_page||"assets");
  var reg=SYNCETC_PAGE_REGISTRY[page];
  if(!reg)return null;
  return reg;
}

function isPageUnlockedForCustomer(pageKey){
  var ctx=activeCustomerContext();
  return !!(ctx.enabled_pages&&ctx.enabled_pages.indexOf(pageKey)>=0);
}

function registryPageOptions(){
  var ctx=activeCustomerContext();
  var listed=ctx.available_pages&&ctx.available_pages.length?ctx.available_pages:Object.keys(SYNCETC_PAGE_REGISTRY);
  return listed.map(function(key){
    var row=SYNCETC_PAGE_REGISTRY[key];
    if(!row)return null;
    return Object.assign({},row,{unlocked:isPageUnlockedForCustomer(key)});
  }).filter(Boolean);
}

function pageRegistryFailHtml(kind, detail){
  var title=kind==="customer"?"CUSTOMER CONTEXT MISSING":"PAGE RENDERER MISSING";
  return '<section class="ds-registry-fail"><strong>'+esc(title)+'</strong><span>'+esc(detail||"The selected customer/page combination is not registered for preview.")+'</span></section>';
}

function registryFieldDefinitions(pageKey){
  var reg=SYNCETC_PAGE_REGISTRY[pageKey]||activePageRegistry();
  if(!reg)return [];
  var key=reg.field_registry_key||reg.page_key;
  if(window.SYNCETC_PAGE_FIELD_REGISTRY&&window.SYNCETC_PAGE_FIELD_REGISTRY[key])return window.SYNCETC_PAGE_FIELD_REGISTRY[key];
...
function ensureRegistrySelection(){
  var ctx=activeCustomerContext();
  if(ctx.missing)return;
  if(!state.sidePageKey || !SYNCETC_PAGE_REGISTRY[state.sidePageKey] || !isPageUnlockedForCustomer(state.sidePageKey)){
    state.sidePageKey=ctx.default_page||ctx.enabled_pages[0]||"assets";
  }
  var reg=activePageRegistry();
  if(reg && (!state.pageAccessScope || state.pageAccessScope==="public")){
    state.pageAccessScope=reg.default_access_scope||ctx.default_access_scope||"public";
  }
}
/* v46 customer/page registry stabilization - END */
...
function installStyles(){
  ...
  style.textContent='\
    ...
    /* v40 clean inheritance loading state - BEGIN */\
    #'+ROOT_ID+' .ds-inheritance-checking{max-width:1180px;margin:10px 0 18px;border:1px solid rgba(30,64,175,.18);border-radius:18px;background:linear-gradient(135deg,#eff6ff,#f8fafc);color:#1e3a8a;padding:14px 16px;box-shadow:0 10px 24px rgba(30,64,175,.08);font-weight:900;}\
    #'+ROOT_ID+' .ds-inheritance-checking strong{display:block;font-size:13px;letter-spacing:.06em;text-transform:uppercase;margin-bottom:5px;color:#1e3a8a!important;}\
    #'+ROOT_ID+' .ds-inheritance-checking span{display:block;font-size:12px;line-height:1.45;color:#475569!important;}\
    #'+ROOT_ID+':not(.ds-audit-ready).ds-style-diagnostic-missing [data-ds-preview-frame]{outline:0!important;animation:none!important;}\
    /* v40 clean inheritance loading state - END */\
    /* v41 Page Specific Settings metadata selector - BEGIN */\
    #'+ROOT_ID+' .ds-side-meta{display:grid;gap:8px;margin-top:10px;}\
    #'+ROOT_ID+' .ds-access-scope-note{border:1px solid rgba(47,128,196,.18);border-radius:12px;background:#eff6ff;color:#1e3a8a;font-size:11px;line-height:1.4;font-weight:800;padding:9px 10px;}\
    #'+ROOT_ID+' .ds-access-scope-note strong{font-weight:950;color:#1e3a8a;}\
    /* v41 Page Specific Settings metadata selector - END */\
    /* v44 Info and Assets preview routing styles - BEGIN */\
    #'+ROOT_ID+' .aero-info-page{max-width:1180px;margin:0 auto 28px;padding:0 18px;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;color:#1e2933;}\
    #'+ROOT_ID+' .aero-info-shell{background:rgba(255,255,255,.94);border:1px solid rgba(18,54,90,.14);border-radius:26px;box-shadow:0 18px 50px rgba(12,38,64,.12);overflow:hidden;}\
    #'+ROOT_ID+' .aero-info-hero{padding:34px 34px 28px;background:linear-gradient(135deg,rgba(18,54,90,.96),rgba(47,128,196,.88)),radial-gradient(circle at top right,rgba(255,255,255,.34),transparent 36%);color:#fff!important;}\
    #'+ROOT_ID+' .aero-info-eyebrow{display:inline-flex;margin-bottom:12px;padding:6px 12px;border-radius:999px;background:rgba(255,255,255,.16);border:1px solid rgba(255,255,255,.24);font-size:12px;font-weight:900;letter-spacing:.08em;text-transform:uppercase;color:#fff!important;}\
    #'+ROOT_ID+' .aero-info-hero h1{margin:0;font-size:clamp(30px,4vw,48px);line-height:1.05;font-weight:900;letter-spacing:-.035em;color:#fff!important;}\
    #'+ROOT_ID+' .aero-info-hero p{max-width:780px;margin:14px 0 0;font-size:17px;line-height:1.65;color:rgba(255,255,255,.9)!important;}\
    #'+ROOT_ID+' .aero-info-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:26px;}\
    #'+ROOT_ID+' .aero-info-stat{padding:14px 16px;border-radius:12px;background:rgba(255,255,255,.14);border:1px solid rgba(255,255,255,.22);color:#fff!important;}\
    #'+ROOT_ID+' .aero-info-stat strong{display:block;margin-bottom:3px;font-size:22px;line-height:1;color:#fff!important;}\
    #'+ROOT_ID+' .aero-info-stat span{display:block;font-size:13px;line-height:1.35;color:rgba(255,255,255,.82)!important;}\
    #'+ROOT_ID+' .aero-info-main{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(340px,.95fr);gap:22px;padding:26px;}\
    #'+ROOT_ID+' .aero-section-card,#'+ROOT_ID+' .aero-faq-panel{border-radius:18px;background:rgba(255,255,255,.86);border:1px solid rgba(18,54,90,.14);box-shadow:0 8px 24px rgba(12,38,64,.08);}\
    #'+ROOT_ID+' .aero-section-card{margin-bottom:18px;padding:22px;}\
    #'+ROOT_ID+' .aero-section-label{display:inline-flex;margin-bottom:10px;padding:5px 10px;border-radius:999px;background:#eaf5ff;color:#12365a!important;font-size:11px;font-weight:900;letter-spacing:.08em;text-transform:uppercase;}\
    #'+ROOT_ID+' .aero-section-card h2,#'+ROOT_ID+' .aero-faq-panel h2{margin:0 0 10px;color:#0b2744!important;font-size:23px;line-height:1.18;font-weight:900;letter-spacing:-.02em;}\
    #'+ROOT_ID+' .aero-section-card p,#'+ROOT_ID+' .aero-faq-panel p{margin:0 0 13px;font-size:15px;line-height:1.7;color:#1e2933!important;}\
    #'+ROOT_ID+' .aero-faq-panel{position:relative;padding:22px;background:linear-gradient(180deg,rgba(234,245,255,.92),rgba(255,255,255,.86));}\
    #'+ROOT_ID+' .aero-faq-header{margin-bottom:15px;}\
    #'+ROOT_ID+' .aero-faq-list{display:grid;gap:10px;}\
    #'+ROOT_ID+' .aero-faq-item{border-radius:14px;background:#fff;border:1px solid rgba(18,54,90,.13);overflow:hidden;}\
    #'+ROOT_ID+' .aero-faq-question{width:100%;display:grid;grid-template-columns:1fr auto;gap:12px;align-items:center;padding:15px;border:0;background:transparent;color:#0b2744;text-align:left;font:inherit;font-size:14px;line-height:1.3;font-weight:900;}\
    #'+ROOT_ID+' .aero-faq-icon{width:26px;height:26px;display:inline-flex;align-items:center;justify-content:center;border-radius:50%;background:#eaf5ff;color:#12365a;font-size:18px;font-weight:900;}\
    #'+ROOT_ID+' .aero-faq-answer{padding:0 15px 16px;color:#1e2933;font-size:14px;line-height:1.65;}\
    #'+ROOT_ID+' .aero-note-strip{margin:0 26px 26px;padding:16px 18px;border-radius:16px;background:rgba(18,54,90,.06);border:1px solid rgba(18,54,90,.12);color:#5d6b78;font-size:13px;line-height:1.55;}\
    @media(max-width:980px){#'+ROOT_ID+' .aero-info-main{grid-template-columns:1fr;}#'+ROOT_ID+' .aero-info-stats{grid-template-columns:1fr;}}\
    /* v44 Info and Assets preview routing styles - END */\
    /* v45 registry fail states - BEGIN */\
    #'+ROOT_ID+' .ds-registry-fail{max-width:1180px;margin:0 auto 24px;border:3px solid #991b1b;border-radius:22px;background:repeating-linear-gradient(45deg,#fee2e2 0,#fee2e2 12px,#fff 12px,#fff 24px);color:#7f1d1d;padding:22px 24px;box-shadow:0 18px 44px rgba(127,29,29,.18);}\
    #'+ROOT_ID+' .ds-registry-fail strong{display:block;font-size:20px;letter-spacing:.06em;text-transform:uppercase;margin-bottom:8px;color:#7f1d1d!important;}\
    #'+ROOT_ID+' .ds-registry-fail span{display:block;font-size:13px;line-height:1.55;font-weight:850;color:#7f1d1d!important;}\
    #'+ROOT_ID+' .ds-registry-chip{display:inline-flex;align-items:center;border-radius:999px;background:#eef2ff;color:#1e1b4b;font-size:10px;font-weight:950;letter-spacing:.06em;text-transform:uppercase;padding:5px 9px;margin-bottom:8px;}\
    /* v45 registry fail states - END */\
    /* v48 no fake data preview contract - BEGIN */\
    #'+ROOT_ID+' .ds-data-contract-stack{max-width:1180px;margin:0 auto 24px;display:grid;gap:14px;}\
    #'+ROOT_ID+' .ds-data-contract-fail{border:3px solid #991b1b;border-radius:22px;background:repeating-linear-gradient(45deg,#fee2e2 0,#fee2e2 12px,#fff 12px,#fff 24px);color:#7f1d1d;padding:20px 22px;box-shadow:0 18px 44px rgba(127,29,29,.16);}\
    #'+ROOT_ID+' .ds-data-contract-fail strong{display:block;font-size:18px;letter-spacing:.06em;text-transform:uppercase;margin-bottom:8px;color:#7f1d1d!important;}\
    #'+ROOT_ID+' .ds-data-contract-fail span{display:block;font-size:13px;line-height:1.55;font-weight:850;color:#7f1d1d!important;}\
    #'+ROOT_ID+' .ds-data-contract-fail code{display:block;margin-top:10px;border:1px solid rgba(127,29,29,.24);border-radius:10px;background:rgba(255,255,255,.82);padding:8px;font-size:12px;line-height:1.45;color:#7f1d1d;white-space:normal;word-break:break-word;}\
    #'+ROOT_ID+' .ds-data-contract-note{border:1px solid rgba(30,64,175,.18);border-radius:16px;background:#eff6ff;color:#1e3a8a;padding:13px 15px;font-size:12px;line-height:1.5;font-weight:850;}\
    /* v48 no fake data preview contract - END */\
    /* v52 real asset card preview - BEGIN */\
    #'+ROOT_ID+' .aero-aircraft-list{display:grid;gap:18px;margin-top:18px;}\
    #'+ROOT_ID+' .aero-aircraft-card{display:grid;grid-template-columns:minmax(0,1fr) minmax(220px,38%);gap:20px;border:1px solid rgba(15,23,42,.12);border-radius:18px;background:#fff;box-shadow:0 14px 34px rgba(15,23,42,.08);padding:22px;overflow:hidden;}\
    #'+ROOT_ID+' .aero-aircraft-card h3{margin:0 0 6px;font-size:26px;line-height:1.1;color:#0f172a;}\
    #'+ROOT_ID+' .aero-aircraft-meta{display:flex;flex-wrap:wrap;gap:8px;margin:0 0 14px;}\
    #'+ROOT_ID+' .aero-aircraft-chip{display:inline-flex;align-items:center;border-radius:999px;background:#eef6ff;border:1px solid rgba(29,78,216,.14);color:#0f3763;font-size:11px;font-weight:900;letter-spacing:.04em;text-transform:uppercase;padding:6px 9px;}\
    #'+ROOT_ID+' .aero-aircraft-desc{margin:0;color:#334155;font-size:14px;line-height:1.6;white-space:pre-line;}\
    #'+ROOT_ID+' .aero-aircraft-rate{margin-top:14px;font-size:13px;font-weight:900;color:#0f172a;}\
    #'+ROOT_ID+' .aero-aircraft-image{min-height:180px;border-radius:14px;background:#e2e8f0;overflow:hidden;border:1px solid rgba(15,23,42,.12);}    #'+ROOT_ID+' .aero-aircraft-image img{width:100%;height:100%;object-fit:cover;display:block;}\
    #'+ROOT_ID+' .aero-aircraft-image-empty{height:100%;min-height:180px;display:flex;align-items:center;justify-content:center;color:#64748b;font-size:12px;font-weight:900;text-transform:uppercase;letter-spacing:.06em;background:linear-gradient(135deg,#f8fafc,#e2e8f0);}\
    #'+ROOT_ID+' .aero-aircraft-source-note{margin-top:14px;border-radius:14px;background:#eff6ff;border:1px solid rgba(29,78,216,.14);color:#1e3a8a;padding:11px 13px;font-size:12px;font-weight:850;line-height:1.45;}\
    @media(max-width:860px){#'+ROOT_ID+' .aero-aircraft-card{grid-template-columns:1fr;}#'+ROOT_ID+' .aero-aircraft-image{min-height:210px;}}\
    /* v52 real asset card preview - END */\
...
function selectedPageLabel(){
  ...
  return state.sidePageKey||"Unregistered Page";
...
/* v64 side drawer state separation - BEGIN */
function objectHasKeys(v){
  return !!(v&&typeof v==="object"&&!Array.isArray(v)&&Object.keys(v).length);
}

function currentCanonicalSidePageKey(){
  var key=selectedPageKey ? selectedPageKey() : "home";
  if(typeof normalizeSettingsPageKeyForCompare==="function")return normalizeSettingsPageKeyForCompare(key);
  return normalizePageKey(key);
}

function loadedValuesForCurrentSidePage(){
  var key=currentCanonicalSidePageKey();
  if(key==="aircraft"&&typeof strictPageSettingsForKey==="function"){
    return Object.assign({},assetDefaultsObject(),strictPageSettingsForKey("aircraft"));
  }
  return pageSettingsObject(selectedPageRow());
}

function sideDrawerDisplayValues(){
  if(state.sideOpen&&objectHasKeys(state.sideDraftValues))return state.sideDraftValues;
  if(state.sideOpen&&objectHasKeys(state.sideLoadedValues))return state.sideLoadedValues;
  return livePageTextValues ? livePageTextValues() : {};
}

function appliedPreviewValuesForCurrentPage(){
  var base=loadedValuesForCurrentSidePage();
  if(state.sideOpen&&objectHasKeys(state.sideAppliedValues))return Object.assign({},base,state.sideAppliedValues);
  return base;
}

function saveValuesFromAppliedState(){
  if(objectHasKeys(state.sideAppliedValues))return cloneObj(state.sideAppliedValues);
  return collectPageTextValues();
}

function resetSideStateToLoadedValues(message){
  var loaded=cloneObj(state.sideLoadedValues||loadedValuesForCurrentSidePage());
  state.sideDraftValues=cloneObj(loaded);
  state.sideAppliedValues={};
  state.sideDirty=false;
  state.sideAppliedDirty=false;
  state.sideSaving=false;
  state.error="";
  state.notice=message||"Unsaved drawer changes discarded.";
}
/* v64 side drawer state separation - END */

function initSideEditState(reset){
  if(!state.sideOpen)return;
  if(!reset&&objectHasKeys(state.sideLoadedValues)&&objectHasKeys(state.sideDraftValues))return;
  var base=loadedValuesForCurrentSidePage();
  state.sideLoadedValues=cloneObj(base);
  state.sideDraftValues=cloneObj(base);
  state.sideAppliedValues={};
  state.pageAccessScope=clean(state.sideDraftValues&&state.sideDraftValues.page_access_scope)||state.pageAccessScope||'public';
  state.sideDirty=false;
  state.sideAppliedDirty=false;
}
...
function renderPageOptions(){
  ensureRegistrySelection();
  var options=registryPageOptions();
  return options.map(function(p){
    var locked=!p.unlocked;
    return '<option value="'+esc(p.page_key)+'" '+(state.sidePageKey===p.page_key?'selected':'')+' '+(locked?'disabled':'')+'>'+esc(p.label+(locked?' · locked':''))+'</option>';
  }).join("");

}

function renderPageFields(){
  var regFields=registryFieldDefinitions(state.sidePageKey);
  if(regFields&&regFields.length){
    var vals=sideDrawerDisplayValues();
    return regFields.map(function(f){
      var bare=f.key.replace(/^[^.]+\./,"");
      var val=vals[f.key]||vals[bare]||"";
      var tag=f.type==="textarea"
        ? '<textarea data-ds-page-field="'+esc(f.key)+'">'+esc(val)+'</textarea>'
        : '<input data-ds-page-field="'+esc(f.key)+'" value="'+esc(val)+'">';
      return '<div class="ds-page-field"><label>'+esc(f.label)+'</label>'+tag+'</div>';
    }).join("");
  }

  if(window.SYNCETC_PAGE_FIELD_REGISTRY&&window.SYNCETC_PAGE_FIELD_REGISTRY[state.sidePageKey]){
    var registryFields=window.SYNCETC_PAGE_FIELD_REGISTRY[state.sidePageKey];
    var vals=sideDrawerDisplayValues();
    return registryFields.map(function(f){
      var val=vals[f.key]||vals[f.key.replace(/^info\./,"")]||"";
      var tag=f.type==="textarea"
        ? '<textarea data-ds-page-field="'+esc(f.key)+'">'+esc(val)+'</textarea>'
        : '<input data-ds-page-field="'+esc(f.key)+'" value="'+esc(val)+'">';
      return '<div class="ds-page-field"><label>'+esc(f.label)+'</label>'+tag+'</div>';
  ...
  var settings=(state.sideOpen?sideDrawerDisplayValues():pageSettingsObject(row));
...
function accessScopeLabel(key){
  var found=PAGE_ACCESS_SCOPES.find(function(x){return x.key===key;});
  return found?found.label:"Public page";
}

function accessScopeNote(key){
  var found=PAGE_ACCESS_SCOPES.find(function(x){return x.key===key;});
  return found?found.note:"Visible without login.";
}

function pageAccessOptionsHtml(){
  return PAGE_ACCESS_SCOPES.map(function(item){
    return '<option value="'+esc(item.key)+'" '+(state.pageAccessScope===item.key?'selected':'')+'>'+esc(item.label)+'</option>';
  }).join("");
}

function pageAccessScopeHtml(){
  return '<div class="ds-side-meta">'+
    '<div class="ds-field"><label for="ds-page-access-scope">Page Placement / Access</label><select id="ds-page-access-scope" class="ds-side-select" data-ds-page-access-scope>'+pageAccessOptionsHtml()+'</select></div>'+
    '<div class="ds-access-scope-note"><strong>Metadata only.</strong> '+esc(accessScopeNote(state.pageAccessScope))+' Final access enforcement belongs to the customer page, router, and login layer, not this Design Studio setting.</div>'+
  '</div>';
}

function renderSideDrawer(){
  return '<button class="ds-side-tab" type="button" data-ds-action="side-open">Page Settings</button>'+
    '<aside class="ds-side-drawer '+(state.sideOpen?'is-open':'')+'" data-ds-side-drawer>'+
      '<div class="ds-side-head"><div><h3>Page Specific Settings</h3><p>'+esc(activeCustomerContext().customer_name||customerName())+' · '+esc(selectedPageLabel())+'</p></div><button class="ds-side-close" type="button" data-ds-action="side-close">×</button></div>'+
      '<div class="ds-side-body">'+
        '<div class="ds-side-tools"><div class="ds-field"><label for="ds-page-selector">Page</label><select id="ds-page-selector" class="ds-side-select" data-ds-page-select>'+renderPageOptions()+'</select></div>'+pageAccessScopeHtml()+'</div>'+
        ...
        '<div class="ds-side-actions">'+
          ...
          '<button class="ds-btn secondary" type="button" data-ds-action="side-close">Close</button>'+
        '</div>'+
        '<div class="ds-side-note">'+esc(state.sideAppliedDirty?'Preview applied. Save Changes is now available.':(state.sideDirty?'Drawer edits pending. Apply Changes to update the preview.':'Page-specific copy and metadata are customer/page-specific.'))+'</div>'+
      '</div>'+
    '</aside>';
}
...
/* v57 safe unsaved-change guard - BEGIN */
function hasUnsavedPageSettingChanges(){
  return !!(state.sideDirty||state.sideAppliedDirty);
}

function unsavedPageSettingMessage(){
  return "You have unsaved Page Specific Settings changes. Continue and discard those changes?";
}

function confirmOrBlockUnsavedPageSettings(){
  if(!hasUnsavedPageSettingChanges())return true;
  return window.confirm(unsavedPageSettingMessage());
}

function clearSideEditStateForConfirmedNavigation(){
  state.sideDirty=false;
  state.sideAppliedDirty=false;
  state.sideSaving=false;
  state.sideDraftValues={};
  state.sideAppliedValues={};
}

function installSafeBeforeUnloadGuard(){
  if(window.__SYNCETC_DS_SAFE_BEFOREUNLOAD_V57)return;
  window.__SYNCETC_DS_SAFE_BEFOREUNLOAD_V57=true;
  window.addEventListener("beforeunload",function(e){
    if(!hasUnsavedPageSettingChanges())return;
    e.preventDefault();
    e.returnValue="";
    return "";
  });
...
function installSafeSelectorGuard(){
  if(window.__SYNCETC_DS_SAFE_SELECTOR_GUARD_V57)return;
  window.__SYNCETC_DS_SAFE_SELECTOR_GUARD_V57=true;

  document.addEventListener("focusin",function(e){
    var t=e.target;
    if(!t||!t.matches)return;
    if(t.matches("select"))t.setAttribute("data-syncetc-last-safe-value",t.value);
  },true);
  ...
  document.addEventListener("change",function(e){
    ...
    try{
      ...
      if(!labelText&&t.parentElement)labelText=t.parentElement.textContent||"";
    }catch(_err){}
    var likelyCustomerOrPage=/customer|profile|page/i.test(labelText)||/customer|profile|page/i.test(t.name||"")||/customer|profile|page/i.test(t.id||"")||/customer|profile|page/i.test(t.getAttribute("data-ds-action")||"")||/customer|profile|page/i.test(t.getAttribute("data-ds-select")||"");
    if(!likelyCustomerOrPage)return;

    if(!confirmOrBlockUnsavedPageSettings()){
      var prev=t.getAttribute("data-syncetc-last-safe-value");
      if(prev!==null)t.value=prev;
      e.preventDefault();
      e.stopImmediatePropagation();
      return false;
    }

    clearSideEditStateForConfirmedNavigation();
    t.setAttribute("data-syncetc-last-safe-value",t.value);
  },true);
}

function installUnsavedGuardsOnce(){
  installSafeBeforeUnloadGuard();
  installSafeSelectorGuard();
}
/* v57 safe unsaved-change guard - END */

/* v55 side drawer button wiring - BEGIN */
function syncSideActionButtonsDom(){
  var r=root();
  if(!r)return;
  var apply=r.querySelector('[data-ds-action="apply-page-text"]');
  var save=r.querySelector('[data-ds-action="save-page-text"]');
  var discard=r.querySelector('[data-ds-action="discard-page-text"]');
  if(apply)apply.disabled=!(state.sideDirty&&!state.sideSaving);
  if(save)save.disabled=!(state.sideAppliedDirty&&!state.sideSaving);
  if(discard)discard.disabled=!((state.sideDirty||state.sideAppliedDirty)&&!state.sideSaving);
}
/* v55 side drawer button wiring - END */
...
function collectPageTextValues(){
  ...
  out.page_access_scope=state.pageAccessScope||'public';
  return out;
}
...
function getPresetBucket(label,presetNames){
  var lists=(typeof getPresetLists==="function") ? getPresetLists() : {};
  var fixedOptions=(typeof FIXED_OPTIONS!=="undefined" && FIXED_OPTIONS) ? FIXED_OPTIONS : {};
  var fixedKeyMap={
    ...
    "Default width":fixedOptions.siteWidth,
    "Header style":fixedOptions.headerTreatment,
    "Hero style":fixedOptions.heroTreatment,
    "Section rhythm":fixedOptions.sectionRhythm,
    "Density":fixedOptions.density,
    "Shadows":fixedOptions.shadow,
    "Borders":fixedOptions.border,
    "Corners":fixedOptions.corner,
    "Gradients":fixedOptions.gradient,
    "Motion":fixedOptions.motion,
    "Background":fixedOptions.background,
    "Image treatment":fixedOptions.imageTreatment,
    "Divider style":fixedOptions.dividerStyle,
    "Emphasis style":fixedOptions.emphasisStyle,
    "Surface/card style":fixedOptions.surfaceStyle
  };
...
function inheritanceCheckingHtml(){
  return '<div class="ds-inheritance-checking">'+
    '<strong>Checking inherited design settings...</strong>'+
    '<span>Design Studio is loading customer profile, preset, typography, color, and page-renderer settings from Supabase.</span>'+
  '</div>';
}

function visibleStyleDiagnosticHtml(){
  if(!state.auditReady)return inheritanceCheckingHtml();
...
function bindPageSpecificSettingsControls(){
  var accessScopeEl=document.querySelector('#'+ROOT_ID+' [data-ds-page-access-scope]');
  if(accessScopeEl){
    accessScopeEl.onchange=function(){
      state.pageAccessScope=clean(this.value)||'public';
...
function ensureVisibleDiagnosticPanel(){
  ...
  var html=visibleStyleDiagnosticHtml();
  if(!html)return;
  ...
  wrap.className=state.auditReady?'ds-visible-inheritance-warning':'ds-inheritance-checking-wrap';
  wrap.innerHTML=html;
...
function refreshInheritanceAuditPanel(){
  if(!state.auditReady){
    var rr=root();
    if(rr){
      rr.classList.remove('ds-style-diagnostic-missing');
      rr.classList.remove('ds-audit-ready');
    }
  ...
  try{
    ...
    console.warn('SyncEtc inheritance audit failed without blocking page render:',err);
    state.styleDiagnostic={ok:true,audits:[],failures:[],warnings:[]};
  }
  var r=root();
  if(r){
    r.classList.add('ds-audit-ready');
...
/* v49 Design Studio real data read bridge - BEGIN */
function currentBridgePageKey(){
  var reg=activePageRegistry&&activePageRegistry();
  return (reg&&reg.page_key)||state.sidePageKey||"assets";
}

function applyPageReadBridgePayload(payload){
  state.pageBridge=payload||null;
  state.pageBridgeError="";
  state.pageBridgeLoading=false;

  if(!payload||payload.ok===false){
    state.pageBridgeError=(payload&&payload.error)||"Design Studio page read returned no usable payload.";
    return;
  }

  state.data=state.data||{};
  state.data.page_bridge=payload;
  state.data.page_settings=payload.page_settings||null;
  state.data.records=state.data.records||{};

  var pageKey=payload.page_key||currentBridgePageKey();
  var settings=payload.page_settings||{};
  var flattened={};
  ...
  Object.keys(settings||{}).forEach(function(k){
    ...
    if(v!==null&&v!==undefined&&String(v).trim()!==""){
      flattened[k]=v;
      if(k.indexOf("aircraft.")===0)flattened[k.replace(/^aircraft\./,"assets.")]=v;
      if(k.indexOf("assets.")===0)flattened[k.replace(/^assets\./,"aircraft.")]=v;
      if(k.indexOf("info.")===0)flattened[k.replace(/^info\./,"")]=v;
    }
  });

  state.sideAppliedValues=Object.assign({},state.sideAppliedValues||{},flattened);
  state.sideDraftValues=Object.assign({},state.sideDraftValues||{},flattened);

  if(pageKey==="assets"){
    var assetRecords=Array.isArray(payload.records)?payload.records:[];
    state.data.records.assets=assetRecords;
    state.data.records.aircraft=assetRecords;
    state.data.assets=assetRecords;
    state.data.aircraft=assetRecords;
    state.assetRecords=assetRecords;
    state.aircraftRecords=assetRecords;
  }else if(pageKey==="info"){
    var infoRecords=payload.records||{};
    state.data.records.info=infoRecords;
    state.data.info_records=infoRecords;
    state.infoRecords=infoRecords;
    if(infoRecords&&infoRecords.faqs)state.faqs=infoRecords.faqs;
    if(infoRecords&&infoRecords.officers)state.officers=infoRecords.officers;
  }

  state.lastBridgeAppliedAt=Date.now();
}

function loadCurrentPageBridge(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  if(!ctx||ctx.missing||!reg||!isPageUnlockedForCustomer(reg.page_key))return Promise.resolve(null);

  state.pageBridgeLoading=true;
  state.pageBridgeError="";

  var token="";
  try{
    if(typeof getToken==="function")token=getToken()||"";
  }catch(e){
    token="";
  }
  ...
  var headers={
    ...
    "apikey":window.SYNCETC_SUPABASE_ANON_KEY||window.SUPABASE_ANON_KEY||""
  };
  ...
  var body={
    ...
    settings_namespace:reg.settings_namespace||reg.page_key,
    legacy_namespace_aliases:reg.legacy_namespace_aliases||[],
    record_kind:reg.page_key==="assets"?"assets":reg.page_key
  };

  return fetch(pageReadUrl(),{
    method:"POST",
    headers:headers,
    body:JSON.stringify(body)
  }).then(function(res){
    return res.json().catch(function(){return null;}).then(function(payload){
      if(!res.ok||!payload)throw new Error((payload&&payload.error)||("Page read bridge failed: HTTP "+res.status));
      applyPageReadBridgePayload(payload);
      return payload;
    });
  }).catch(function(err){
    console.warn("SyncEtc page read bridge failed:",err);
    state.pageBridgeLoading=false;
    state.pageBridgeError=err&&err.message?err.message:String(err);
    return null;
  });
}

function bridgeStatusFailHtml(){
  if(state.pageBridgeLoading){
    return '<div class="ds-data-contract-note">Loading real customer/page data from '+esc(PAGE_READ_FUNCTION_NAME)+'...</div>';
  }
  if(state.pageBridgeError){
    return pageDataFailHtml(
      "DESIGN STUDIO DATA BRIDGE NOT CONNECTED",
      "The page registry is working, but Design Studio could not load real page settings/records from the Supabase Edge Function. During this testing phase the function should be deployed with Verify JWT OFF.",
      state.pageBridgeError
    );
  }
  return "";
}
/* v49 Design Studio real data read bridge - END */

/* v50 bridge debug helper - BEGIN */
window.SYNCETC_TEST_PAGE_READ_BRIDGE=function(pageKey){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var customerKey=(ctx&&ctx.customer_key)||"150th-aero";
  var body={
    customer_key:customerKey,
    page_key:pageKey||state.sidePageKey||"assets",
    record_kind:(pageKey||state.sidePageKey||"assets")==="assets"?"assets":(pageKey||state.sidePageKey||"assets")
  };
  return fetch(pageReadUrl(),{
    method:"POST",
    headers:{
    ...
    applyPageReadBridgePayload(payload);
    console.log("SYNCETC_TEST_PAGE_READ_BRIDGE",payload);
    renderFrame();
    return payload;
  });
};
/* v50 bridge debug helper - END */



function pageDataFailHtml(title, detail, code){
  return '<section class="ds-data-contract-fail">'+
    '<strong>'+esc(title)+'</strong>'+
    '<span>'+esc(detail||"Required customer/page data is not connected.")+'</span>'+
    (code?'<code>'+esc(code)+'</code>':'')+
  '</section>';
}

function dataContractStack(items){
  var bridge=bridgeStatusFailHtml();
  return '<div class="ds-data-contract-stack">'+
    '<div class="ds-data-contract-note">Design Studio preview contract: no fake customer content is allowed. If customer page settings or customer records are not connected, this panel must fail visibly instead of rendering placeholder data.</div>'+
    (bridge||'')+
    items.join('')+
  '</div>';
}

function realPageValuesFor(prefix){
  var bridgeSettings=(state.pageBridge&&state.pageBridge.page_settings)||{};
  var applied=state.sideAppliedValues||{};
  var draft=state.sideDraftValues||{};
  var live=livePageTextValues ? livePageTextValues() : {};
  var vals=Object.assign({},live,draft,applied,bridgeSettings);
  var out={};
  Object.keys(vals||{}).forEach(function(k){
    if((k.indexOf(prefix+".")===0 || k.indexOf(prefix+"_")===0 || (prefix==="assets"&&k.indexOf("aircraft.")===0) || (prefix==="aircraft"&&k.indexOf("assets.")===0)) && clean(vals[k]))out[k]=vals[k];
  });
  return out;
}

function hasAnyRealPageSetting(prefix){
  return Object.keys(realPageValuesFor(prefix)).length>0;
}

function hasConnectedRecordData(kind){
  var d=obj(state.data||{});
  var bridge=state.pageBridge||{};
  var bridgeRecords=bridge.records||null;

  if(kind==="assets"){
    if(Array.isArray(bridgeRecords)&&bridgeRecords.length)return true;
    if(Array.isArray(state.assetRecords)&&state.assetRecords.length)return true;
    if(Array.isArray(state.aircraftRecords)&&state.aircraftRecords.length)return true;
    if(Array.isArray(d.assets)&&d.assets.length)return true;
    if(Array.isArray(d.aircraft)&&d.aircraft.length)return true;
    if(d.records&&Array.isArray(d.records.assets)&&d.records.assets.length)return true;
    if(d.records&&Array.isArray(d.records.aircraft)&&d.records.aircraft.length)return true;
  }

  if(kind==="info"){
    if(bridgeRecords&&typeof bridgeRecords==="object"&&(arr(bridgeRecords.faqs).length||arr(bridgeRecords.officers).length||arr(bridgeRecords.sections).length||bridgeRecords.content))return true;
    if(state.infoRecords&&typeof state.infoRecords==="object"&&(arr(state.infoRecords.faqs).length||arr(state.infoRecords.officers).length||arr(state.infoRecords.sections).length||state.infoRecords.content))return true;
  }

  return false;
}

function pageSettingsMissingHtml(pageKey, namespace){
  var ctx=activeCustomerContext();
  return pageDataFailHtml(
    "CUSTOMER PAGE SETTINGS NOT CONNECTED",
    "The selected page is registered, but Design Studio has not loaded real saved page settings for this customer/page combination.",
    "customer_key="+(ctx.customer_key||"unknown")+"; page_key="+pageKey+"; settings_namespace="+namespace
  );
}

function recordDataMissingHtml(pageKey, recordKind){
  var ctx=activeCustomerContext();
  var label=recordKind==="assets"?"CUSTOMER ASSET RECORDS NOT CONNECTED":"CUSTOMER RECORD DATA NOT CONNECTED";
  return pageDataFailHtml(
    label,
    "The page renderer must use customer-owned Supabase/CMS records. No record data was found for this preview, so Design Studio is refusing to show fake records.",
    "customer_key="+(ctx.customer_key||"unknown")+"; page_key="+pageKey+"; record_kind="+recordKind
  );
}
/* v48 no fake data preview contract - END */

function renderInfoPreviewForDesignStudio(){
  var failures=[];
  var hasSettings=hasAnyRealPageSetting("info");
  var hasRecords=hasConnectedRecordData("info");

  if(!hasSettings)failures.push(pageSettingsMissingHtml("info","info"));
  if(!hasRecords)failures.push(recordDataMissingHtml("info","info"));

  if(failures.length)return dataContractStack(failures);

  var vals=livePageTextValues ? livePageTextValues() : {};
  function pick(k){
    return esc(vals["info."+k]||vals[k]||"");
  }

  return '<section class="aero-info-page" data-design-studio-preview-page="info" data-registry-page="info">'+
    '<div class="aero-info-shell">'+
      '<section class="aero-info-hero">'+
        '<div class="aero-info-eyebrow">'+pick("heroEyebrow")+'</div>'+
        '<h1>'+pick("heroTitle")+'</h1>'+
        '<p>'+pick("heroIntro")+'</p>'+
      '</section>'+
      '<main class="aero-info-main">'+
        '<div class="aero-info-column">'+
          '<section class="aero-section-card"><div class="aero-section-label">'+pick("sections.0.label")+'</div><h2>'+pick("sections.0.title")+'</h2><p>'+pick("sections.0.body.0")+'</p><p>'+pick("sections.0.body.1")+'</p></section>'+
          '<section class="aero-section-card"><div class="aero-section-label">'+pick("sections.1.label")+'</div><h2>'+pick("sections.1.title")+'</h2><p>'+pick("sections.1.body.0")+'</p><p>'+pick("sections.1.body.1")+'</p></section>'+
          '<section class="aero-section-card"><div class="aero-section-label">'+pick("boardLabel")+'</div><h2>'+pick("boardTitle")+'</h2><p>'+pick("boardIntro")+'</p></section>'+
        '</div>'+
        '<aside class="aero-info-column"><section class="aero-faq-panel"><div class="aero-faq-header"><div class="aero-section-label">'+pick("faqLabel")+'</div><h2>'+pick("faqTitle")+'</h2><p>'+pick("faqIntro")+'</p></div><div class="ds-data-contract-note">FAQ/officer/body records are intentionally record-fed. They should come from Supabase tables, not from individual side-loader fields.</div></section></aside>'+
      '</main>'+
      '<div class="aero-note-strip"><strong>Note:</strong> '+pick("note")+'</div>'+
    '</div>'+
  '</section>';
}


/* v52 real asset record rendering - BEGIN */

/* v53 shared Assets renderer loader - BEGIN */
var SHARED_ASSETS_RENDERER_URL=window.SYNCETC_ASSETS_RENDERER_URL||"https://feskesen.github.io/syncetc-webflow-assets/COMPONENT-assets-renderer-v2.js";

function sharedAssetsRenderer(){
  return window.SYNCETC_ASSETS_RENDERER_V2||window.SYNCETC_ASSETS_RENDERER_V1||null;
}

function ensureSharedAssetsRenderer(){
  if(sharedAssetsRenderer())return Promise.resolve(sharedAssetsRenderer());
  if(state.assetsRendererRequested)return Promise.resolve(null);
  state.assetsRendererRequested=true;
  state.assetsRendererError="";
  return new Promise(function(resolve,reject){
    var existing=document.querySelector('script[data-syncetc-assets-renderer="v1"]');
    if(existing){
      existing.addEventListener("load",function(){resolve(sharedAssetsRenderer());},{once:true});
      existing.addEventListener("error",function(){reject(new Error("Shared Assets renderer failed to load."));},{once:true});
      return;
    }
    var s=document.createElement("script");
    s.src=SHARED_ASSETS_RENDERER_URL;
    s.async=true;
    s.dataset.syncetcAssetsRenderer="v1";
    s.onload=function(){resolve(sharedAssetsRenderer());};
    s.onerror=function(){reject(new Error("Shared Assets renderer failed to load from "+SHARED_ASSETS_RENDERER_URL));};
    document.head.appendChild(s);
  }).then(function(renderer){
    state.assetsRendererError=renderer?"":"Shared Assets renderer loaded but did not register.";
    renderFrame();
    return renderer;
  }).catch(function(err){
    state.assetsRendererError=err&&err.message?err.message:String(err);
    renderFrame();
    return null;
  });
}
...
/* v63 strict livePageTextValues override - BEGIN */
function livePageTextValues(){
  return appliedPreviewValuesForCurrentPage();
}
/* v63 strict livePageTextValues override - END */

function valuesForSharedAssetsRenderer(records){
  var loadedBridge=(state.pageBridge&&state.pageBridge.page_settings)||{};
  var loadedValues=loadedValuesForCurrentSidePage();
  var appliedValues=(state.sideOpen&&objectHasKeys(state.sideAppliedValues))?state.sideAppliedValues:{};
  var vals=Object.assign({},loadedBridge,loadedValues,appliedValues);
  vals.aircraft=records||[];
  vals.assets=records||[];
  return vals;
}
/* v53 shared Assets renderer loader - END */

function connectedAssetRecords(){
  var d=obj(state.data||{});
  var bridge=state.pageBridge||{};
  var candidates=[
    bridge.records,
    state.assetRecords,
    state.aircraftRecords,
    d.assets,
    d.aircraft,
    d.records&&d.records.assets,
    d.records&&d.records.aircraft
  ];
...
function assetRecordValue(row,keys){
  row=row||{};
  for(var i=0;i<keys.length;i++){
    var key=keys[i];
    if(row[key]!==null&&row[key]!==undefined&&String(row[key]).trim()!=="")return row[key];
    if(row.raw&&row.raw[key]!==null&&row.raw[key]!==undefined&&String(row.raw[key]).trim()!=="")return row.raw[key];
  }
  return "";
}

function renderConnectedAssetCard(row,index){
  var identifier=assetRecordValue(row,["asset_identifier","tail_number","asset_name","public_label","asset_key","aircraft_slug"])||("Asset "+(index+1));
  var type=assetRecordValue(row,["asset_type","aircraft_type","type","model"]);
  var base=assetRecordValue(row,["home_base","base","airport"]);
  var status=assetRecordValue(row,["status","availability_status"]);
  var year=assetRecordValue(row,["model_year","year"]);
  var rate=assetRecordValue(row,["hourly_rate","rate","display_rate"]);
  var desc=assetRecordValue(row,["public_description_plain","description","summary","notes"]);
  var image=assetRecordValue(row,["exterior_photo_url","image_url","photo_url","asset_image_url"]);
  var panel=assetRecordValue(row,["panel_photo_url"]);

  var chips=[];
  if(type)chips.push(type);
  if(year)chips.push(year);
  if(base)chips.push(base);
  if(status)chips.push(status);

  return '<article class="aero-aircraft-card" data-asset-record-index="'+index+'">'+
    '<div class="aero-aircraft-copy">'+
      '<h3>'+esc(identifier)+'</h3>'+
      (chips.length?'<div class="aero-aircraft-meta">'+chips.map(function(c){return '<span class="aero-aircraft-chip">'+esc(c)+'</span>';}).join('')+'</div>':'')+
      (desc?'<p class="aero-aircraft-desc">'+esc(desc)+'</p>':'')+
      (rate?'<div class="aero-aircraft-rate">Rate: '+esc(rate)+'</div>':'')+
      '<div class="aero-aircraft-source-note">Rendered from customer asset record data, not fake preview data.</div>'+
    '</div>'+
    '<div class="aero-aircraft-image">'+
      (image?'<img src="'+esc(image)+'" alt="'+esc(identifier)+'">':'<div class="aero-aircraft-image-empty">No image connected</div>')+
    '</div>'+
  '</article>';
}
/* v52 real asset record rendering - END */

function renderAssetsPreviewForDesignStudio(){
  var failures=[];
  var hasSettings=hasAnyRealPageSetting("aircraft") || hasAnyRealPageSetting("assets");
  var records=connectedAssetRecords();
  var hasRecords=records.length>0;

  if(!hasSettings)failures.push(pageSettingsMissingHtml("assets","assets / legacy aircraft"));
  if(!hasRecords)failures.push(recordDataMissingHtml("assets","assets"));
  if(failures.length)return dataContractStack(failures);

  var renderer=sharedAssetsRenderer();
  if(!renderer){
    ensureSharedAssetsRenderer();
    return dataContractStack([
      pageDataFailHtml(
        state.assetsRendererError?"SHARED ASSETS RENDERER NOT LOADED":"SHARED ASSETS RENDERER LOADING",
        state.assetsRendererError||"Design Studio is loading the same shared Assets renderer used by the live Assets page.",
        SHARED_ASSETS_RENDERER_URL
      )
    ]);
  }

  return renderer.renderPage(valuesForSharedAssetsRenderer(records),{mode:"design-studio"});
}


/* v51 force bridge load during render - BEGIN */
function ensureBridgeForCurrentPage(){
  var reg=activePageRegistry&&activePageRegistry();
  var ctx=activeCustomerContext&&activeCustomerContext();
  if(!reg||!ctx||ctx.missing||!isPageUnlockedForCustomer(reg.page_key))return;
  var key=(ctx.customer_key||"")+"::"+(reg.page_key||"");
  if(state.pageBridge&&state.pageBridge.customer_key===ctx.customer_key&&state.pageBridge.page_key===reg.page_key)return;
  if(state.pageBridgeLoading)return;
  if(state.pageBridgeRequestedFor===key)return;
  state.pageBridgeRequestedFor=key;
  loadCurrentPageBridge().then(function(){renderFrame();});
}
/* v51 force bridge load during render - END */


/* v52 short asset diagnostic helper - BEGIN */
window.SYNCETC_ASSET_RECORD_COUNT=function(){
  var records=connectedAssetRecords();
  console.log("SYNCETC_ASSET_RECORD_COUNT",records.length,records,"renderer",sharedAssetsRenderer()&&sharedAssetsRenderer().version);
  return records.length;
};
/* v52 short asset diagnostic helper - END */

function renderSelectedPagePreview(){
  ensureRegistrySelection();
  ensureBridgeForCurrentPage();
  var ctx=activeCustomerContext();
  if(ctx.missing)return pageRegistryFailHtml("customer","Customer key '"+esc(ctx.customer_key)+"' is not registered. Add it to SYNCETC_CUSTOMER_REGISTRY before previewing customer pages.");
  var reg=activePageRegistry();
  if(!reg)return pageRegistryFailHtml("page","Page key '"+esc(state.sidePageKey)+"' is not enabled or registered for customer '"+esc(ctx.customer_name)+"'.");

  if(reg.page_key==="info"){
    if(typeof renderInfoPreviewForDesignStudio==="function")return renderInfoPreviewForDesignStudio();
    return pageRegistryFailHtml("page","Info is registered, but renderInfoPreviewForDesignStudio is missing.");
  }

  if(reg.page_key==="assets"){
    if(typeof renderAssetsPreviewForDesignStudio==="function")return renderAssetsPreviewForDesignStudio();
    return pageRegistryFailHtml("page","Assets is registered, but renderAssetsPreviewForDesignStudio is missing.");
  }

  return pageRegistryFailHtml("page","No renderer is registered for '"+esc(reg.page_key)+"'.");
...
function applyPageText(){
  var draft=collectPageTextValues();
  state.sideDraftValues=cloneObj(draft);
  state.sideAppliedValues=cloneObj(draft);
  state.sideDirty=false;
...
function discardPageText(doRender){
  resetSideStateToLoadedValues('Unsaved drawer changes discarded.');
...
/* v63 strict page-settings row selection - BEGIN */
function normalizeSettingsPageKeyForCompare(key){
  key=normalizePageKey(key);
  if(key==="assets")return "aircraft";
  if(key==="aircraft")return "aircraft";
  return key;
}

function strictSettingsRows(){
  return pageRows().filter(function(p){
    return p && (p.is_enabled===undefined || p.is_enabled===null || p.is_enabled===true || String(p.is_enabled)==="true");
  });
}

function strictSelectedSettingsRowForKey(canonicalKey){
  canonicalKey=normalizeSettingsPageKeyForCompare(canonicalKey);
  var rows=strictSettingsRows();
  var exact=rows.find(function(p){
    return normalizeSettingsPageKeyForCompare(p.page_key)===canonicalKey;
  });
  return exact||{};
}

function strictPageSettingsForKey(canonicalKey){
  var row=strictSelectedSettingsRowForKey(canonicalKey);
  return Object.assign({},obj(row.settings_json),obj(row.current_settings_json));
}

function detectSettingsNamespace(values){
  values=values||{};
  var keys=Object.keys(values);
  if(keys.some(function(k){return /^aircraft\./.test(k);}))return "aircraft";
  if(keys.some(function(k){return /^assets\./.test(k);}))return "assets";
  return "";
}

function currentPreviewPageKeyForSave(){
  var candidates=[
    state.preview_page_key,
    state.previewPageKey,
    state.active_page_key,
    state.activePageKey,
    state.current_page_key,
    state.currentPageKey,
    state.selected_page_key,
  ...
  return selectedPageKey ? selectedPageKey() : "";
}

function currentPreviewPageLabelForSave(){
  var label=selectedPageLabel ? selectedPageLabel() : "";
  if(/asset|aircraft/i.test(label||""))return "Assets";
  return label||"";
}

function canonicalPageKeyForSettingsSave(rawKey,values,label){
  rawKey=normalizePageKey(rawKey);
  var ns=detectSettingsNamespace(values);
  var text=(rawKey+" "+(label||"")).toLowerCase();
  if(ns==="aircraft"||ns==="assets")return "aircraft";
  if(text.indexOf("aircraft")!==-1||text.indexOf("asset")!==-1)return "aircraft";
  return rawKey||"home";
}

function strictCurrentSettingsKey(){
  var values=(state.sideAppliedValues&&Object.keys(state.sideAppliedValues).length)?state.sideAppliedValues:(state.sideDraftValues&&Object.keys(state.sideDraftValues).length?state.sideDraftValues:(collectPageTextValues?collectPageTextValues():{}));
  return canonicalPageKeyForSettingsSave(currentPreviewPageKeyForSave(),values,currentPreviewPageLabelForSave());
}

function selectedPageRowForSettingsSave(values){
  var canonical=canonicalPageKeyForSettingsSave(currentPreviewPageKeyForSave(),values,currentPreviewPageLabelForSave());
  return strictSelectedSettingsRowForKey(canonical);
}
/* v63 strict page-settings row selection - END */

/* v61 canonical save page-key alignment - BEGIN */
function currentPreviewPageKeyForSave(){
  var candidates=[
    state.preview_page_key,
    state.previewPageKey,
  ...
  try{
    var r=root();
    var checked=r&&r.querySelector('[data-page-key][aria-selected="true"],[data-page-key].is-active,[data-page-key].active,[data-page-key][data-active="true"]');
    if(checked){
      var k=clean(checked.getAttribute("data-page-key"));
      if(k)return k;
    }
  }catch(_err){}
...
function selectedPageRowForSettingsSave(values){
  var canonical=canonicalPageKeyForSettingsSave(currentPreviewPageKeyForSave(),values,currentPreviewPageLabelForSave());
  var rows=pageRows();
  var exact=rows.find(function(p){return normalizePageKey(p.page_key)===canonical;});
  if(exact)return exact;
  if(canonical==="aircraft"){
    return rows.find(function(p){
      var k=normalizePageKey(p.page_key);
      var label=String(p.page_label||"").toLowerCase();
      return k==="assets"||k==="aircraft"||label.indexOf("asset")!==-1||label.indexOf("aircraft")!==-1;
    })||{};
  }
  return selectedPageRow ? selectedPageRow() : {};
}
/* v61 canonical save page-key alignment - END */

/* v58 page settings save helpers - BEGIN */
function canonicalCustomerKeyForSave(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  return (ctx&&ctx.customer_key)||state.customer_key;
}

function normalizePageKeyForSave(key){
  key=normalizePageKey(key);
  if(key==="assets")return "aircraft";
  if(key==="aircraft")return "aircraft";
  return key;
...
function pageSettingsSavePayload(values,fields,row,key,label){
  var canonicalCustomerKey=canonicalCustomerKeyForSave();
  var saveKey=canonicalPageKeyForSettingsSave(key,values,label);
  return {
    ...
    payload:{
      customer_key:canonicalCustomerKey,
      page_key:saveKey,
      page_label:(saveKey==="assets"?"Assets":(label||"")),
      ...
      is_enabled:true,
      design_studio_active_page_key:v77ActiveRegistryPageKey(),
      design_studio_version:VERSION
    }
  };
}

function saveActionHeaders(token){
...
function applySavedPageSettingsLocally(values,saved,key,label,fields){
  var saveKey=canonicalPageKeyForSettingsSave(key,values,label);
  state.data=state.data||{};
  var rows=pageRows().filter(function(p){return normalizePageKeyForSave(p.page_key)!==saveKey;});
  var row=saved&&saved.page_key?saved:{
    customer_key:canonicalCustomerKeyForSave(),
    page_key:saveKey,
    page_label:(saveKey==="aircraft"?"Assets":label),
    is_enabled:true
  };
  row.current_settings_json=values;
  row.settings_json=values;
  row.fields_json=fields;
  rows.push(row);
  state.data.customer_page_settings=rows;

  if(state.pageBridge&&normalizePageKeyForSave(state.pageBridge.page_key)===saveKey){
    state.pageBridge.page_settings=Object.assign({},values);
    state.pageBridge.page_settings_found=true;
    state.data.page_bridge=state.pageBridge;
    state.data.page_settings=Object.assign({},values);
  }

  state.sideSaving=false;
  state.sideDirty=false;
  state.sideAppliedDirty=false;
  state.sideLoadedValues=cloneObj(values);
  state.sideDraftValues=cloneObj(values);
  state.sideAppliedValues={};
  state.error="";
  state.notice="Page settings saved for "+(saveKey==="assets"?"Assets":label)+".";
}
/* v58 page settings save helpers - END */


/* v63 strict override for save/read/discard - BEGIN */
function selectedPageRowForSettingsSave(values){
  var canonical=canonicalPageKeyForSettingsSave(currentPreviewPageKeyForSave(),values,currentPreviewPageLabelForSave());
  return strictSelectedSettingsRowForKey(canonical);
}

function legacyDiscardUpperRemoved(){
  discardPageText(true);
}
/* v63 strict override for save/read/discard - END */


/* v77 hardened save page-key alignment - BEGIN */
function v77ActiveRegistryPageKey(){
  var reg=null;
  try{reg=activePageRegistry&&activePageRegistry();}catch(_err){reg=null;}
  var key=clean((reg&&reg.page_key)||state.sidePageKey||currentPreviewPageKeyForSave()||(selectedPageKey&&selectedPageKey())||"");
  return normalizePageKey(key||"home");
}

function v77IsAssetsSave(values,label){
  values=values||{};
  var key=v77ActiveRegistryPageKey();
  var ns=detectSettingsNamespace(values);
  var text=(key+" "+(label||"")).toLowerCase();
  return key==="assets"||key==="aircraft"||ns==="assets"||ns==="aircraft"||text.indexOf("asset")!==-1||text.indexOf("aircraft")!==-1;
}
...
function canonicalPageKeyForSettingsSave(rawKey,values,label){
  if(v77IsAssetsSave(values,label))return "assets";
  rawKey=normalizePageKey(rawKey||v77ActiveRegistryPageKey());
  return rawKey||"home";
}

function selectedPageRowForSettingsSave(values){
  var saveKey=canonicalPageKeyForSettingsSave(v77ActiveRegistryPageKey(),values,currentPreviewPageLabelForSave());
  var rows=pageRows();
  var exact=rows.find(function(p){return normalizePageKeyForSave(p.page_key)===saveKey;});
  return exact||{};
}

function v77SaveValuesFromAppliedState(){
  if(objectHasKeys(state.sideAppliedValues))return cloneObj(state.sideAppliedValues);
  return collectPageTextValues();
}

function v77SaveTargetState(values){
  var label=currentPreviewPageLabelForSave()||selectedPageLabel();
  var saveKey=canonicalPageKeyForSettingsSave(v77ActiveRegistryPageKey(),values,label);
  return {
    page_key:saveKey,
    page_label:saveKey==="assets"?"Assets":(label||titleFromKey(saveKey)),
    customer_key:canonicalCustomerKeyForSave()
  };
}
/* v77 hardened save page-key alignment - END */
...
function savePageText(){
  ...
  var initialLabel=currentPreviewPageLabelForSave();
  if(!state.sideAppliedDirty){
    state.notice="Apply Changes before saving.";
    state.error="";
    updateStatus();
    return;
  }

  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var key=target.page_key;
  var row=selectedPageRowForSettingsSave(values);
  var label=target.page_label;
  var fields=normalizePageFields(row,key);
  var requestBody=pageSettingsSavePayload(values,fields,row,key,label);

  state.sideSaving=true;
  state.error="";
  state.notice="Saving page settings...";
  renderFrame();

  fetch(ACTION_URL,{
    method:"POST",
    headers:saveActionHeaders(token),
    body:JSON.stringify(requestBody)
  })
  .then(function(res){
    return res.json().catch(function(){return null;}).then(function(body){
      if(!res.ok||!body||body.ok===false){
        var msg=errorMessageFromResponse(body,res.status);
        if(res.status===401)msg+=" Check that syncetc-site-settings-action is deployed with Verify JWT ON and that you are signed in.";
        if(res.status===403)msg+=" Check that your user has a platform admin or customer admin role for this customer.";
        throw new Error(msg);
      }
      return body;
    });
  ...
  .then(function(body){
    ...
    applySavedPageSettingsLocally(values,saved,key,label,fields);
    renderFrame();
...
function renderFrame(){
  ...
  mount.innerHTML='<div id="'+ROOT_ID+'" class="'+(state.loading?'ds-skeleton ':'')+(state.fullPreview?'ds-full-preview ':'')+(state.sideOpen?'ds-page-text-mode ':'')+(diag.ok?'':'ds-style-diagnostic-missing')+'">'+
    ...
    '<div class="ds-shell">'+
      '<div class="ds-hero-top"><div><span class="ds-kicker">SyncEtc Company Tool</span><div class="ds-title-row"><div class="ds-title-copy"><h1>Design Studio</h1><div class="ds-sample-preview-note">Design Studio 2.1: visual layout and design-profile editor. Page creation moves to Page Builder.</div></div><a class="ds-pagebuilder-link" style="display:inline-flex;align-items:center;justify-content:center;gap:8px;border:1px solid rgba(11,31,51,.18);border-radius:999px;padding:10px 14px;background:#fff;color:#0b1f33;text-decoration:none;font-weight:900;font-size:13px;box-shadow:0 8px 20px rgba(11,31,51,.08);white-space:nowrap;line-height:1;" href="/page-builder">Page Builder →</a></div></div><div class="ds-version">'+esc(VERSION)+'</div></div>'+
...
/* v55 short side drawer diagnostic - BEGIN */
window.SYNCETC_SIDE_DRAWER_STATE=function(){
  var r=root();
  var out={
    version:VERSION,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    sideSaving:state.sideSaving,
    applyDisabled:!!(r&&r.querySelector('[data-ds-action="apply-page-text"]')&&r.querySelector('[data-ds-action="apply-page-text"]').disabled),
    saveDisabled:!!(r&&r.querySelector('[data-ds-action="save-page-text"]')&&r.querySelector('[data-ds-action="save-page-text"]').disabled),
    discardDisabled:!!(r&&r.querySelector('[data-ds-action="discard-page-text"]')&&r.querySelector('[data-ds-action="discard-page-text"]').disabled)
  };
  console.log("SYNCETC_SIDE_DRAWER_STATE",out);
  return out;
};
/* v55 short side drawer diagnostic - END */

function bindFrame(){

  if(!window.__SYNCETC_DS_ESC_CLOSE_V87){
    window.__SYNCETC_DS_ESC_CLOSE_V87=true;
    document.addEventListener('keydown',function(e){
      if(e.key!=='Escape')return;
      if(!state.sideOpen)return;
      if(hasSideUnsaved()&&!window.confirm('You have unsaved Page Specific Settings changes. Close and lose those changes, or cancel to keep editing?'))return;
      state.sideOpen=false;
      state.sideDirty=false;
      state.sideAppliedDirty=false;
      state.sideSaving=false;
      state.sideLoadedValues={};
      state.sideDraftValues={};
      state.sideAppliedValues={};
      state.error='';
      state.notice='';
  ...
  r.querySelectorAll('[data-ds-action]').forEach(function(btn){
    btn.addEventListener('click',function(){
      ...
      if(action==='side-close'){if(hasSideUnsaved()&&!window.confirm('You have unsaved Page Specific Settings changes. Close and lose those changes, or cancel to keep editing?'))return;state.sideOpen=false;state.sideDirty=false;state.sideAppliedDirty=false;state.sideSaving=false;state.sideLoadedValues={};state.sideDraftValues={};state.sideAppliedValues={};state.error='';state.notice='';renderFrame();return;}
      if(action==='apply-page-text'){applyPageText();return;}
      if(action==='save-page-text'){savePageText();return;}
      if(action==='discard-page-text'){if(hasSideUnsaved()&&!window.confirm('You have unsaved Page Specific Settings changes. Close and lose those changes, or cancel to keep editing?'))return;state.sideOpen=false;state.sideDirty=false;state.sideAppliedDirty=false;state.sideSaving=false;state.sideLoadedValues={};state.sideDraftValues={};state.sideAppliedValues={};state.error='';state.notice='';renderFrame();return;}
...
/* v76 close wiring diagnostic - BEGIN */
window.SYNCETC_V87_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V87,
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    discardButtonCount:[].filter.call(document.querySelectorAll('button'),function(b){return /Discard Changes/i.test(b.textContent||'');}).length
  };
  console.log('SYNCETC_V87_CLOSE_WIRING_STATE',out);
  return out;
};
/* v76 close wiring diagnostic - END */


/* v77 save diagnostic - BEGIN */
window.SYNCETC_V87_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
    ...
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    activeRegistryPageKey:v77ActiveRegistryPageKey(),
    savePageKey:target.page_key,
    savePageLabel:target.page_label,
    customerKey:target.customer_key,
    appliedKeys:Object.keys(state.sideAppliedValues||{}),
    draftKeys:Object.keys(state.sideDraftValues||{})
  };
  console.log("SYNCETC_V87_SAVE_STATE",out);
  return out;
};
/* v77 save diagnostic - END */


/* v79 narrow customer registry diagnostic - BEGIN */
window.SYNCETC_V87_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    stateCustomerKey:state.customer_key,
    activeCustomerKey:ctx&&ctx.customer_key,
    activeCustomerName:ctx&&ctx.customer_name,
    activePageKey:reg&&reg.page_key,
    sidePageKey:state.sidePageKey,
    pageRowCount:arr(state.data&&state.data.customer_page_settings).length,
    assetRecordCount:(typeof connectedAssetRecords==="function"?connectedAssetRecords().length:null),
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V87_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V87_SCOPE_STATE",out);
  return out;
};
/* v79 narrow customer registry diagnostic - END */


/* v80 Design Studio 2.1 diagnostic - BEGIN */
window.SYNCETC_V87_STUDIO_STATE=function(){
  var out={
    version:VERSION,
    pageBuilderLinkCount:document.querySelectorAll('.ds-pagebuilder-link[href="/page-builder"]').length,
    hasSamplePreviewNote:!!document.querySelector(".ds-sample-preview-note"),
    hasSaveFunction:typeof savePageText==="function",
    hasCloseButton:document.querySelectorAll('[data-ds-action="side-close"]').length
  };
  console.log("SYNCETC_V87_STUDIO_STATE",out);
  return out;
};
/* v80 Design Studio 2.1 diagnostic - END */


/* v81 Design Studio header normalizer - BEGIN */
function v87NormalizeDesignStudioHeader(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;

  var version=root.querySelector(".ds-version");
  var buttonStyle="display:inline-flex;align-items:center;justify-content:center;gap:8px;border:1px solid rgba(11,31,51,.18);border-radius:999px;padding:10px 14px;background:#fff;color:#0b1f33;text-decoration:none;font-weight:900;font-size:13px;box-shadow:0 8px 20px rgba(11,31,51,.08);white-space:nowrap;line-height:1;margin-right:10px;";

  function ensureButton(cls,href,text){
    var link=root.querySelector("a."+cls+'[href="'+href+'"]')||root.querySelector('a[href="'+href+'"]');
    if(!link){
  ...
  var cm=ensureButton("ds-customer-manager-link ds-v87-tool-pill","/customer-manager","Customer Manager");
  var pb=ensureButton("ds-pagebuilder-link ds-v87-tool-pill","/page-builder","Page Builder →");

  if(version&&version.parentElement){
    var bar=version.parentElement;
    bar.style.display="flex";
    bar.style.alignItems="center";
    bar.style.justifyContent="flex-end";
    bar.style.gap="10px";
    if(cm.parentElement!==bar)bar.insertBefore(cm,version);
    if(pb.parentElement!==bar)bar.insertBefore(pb,version);
  }else{
    var heading=root.querySelector("h1,h2,.ds-title,.ds-hero-title,.ds-brand-title");
    var parent=heading&&heading.parentElement?heading.parentElement:root;
    if(cm.parentElement!==parent)parent.appendChild(cm);
    if(pb.parentElement!==parent)parent.appendChild(pb);
  }

  [].slice.call(root.querySelectorAll('a[href="/page-builder"]')).forEach(function(a){if(a!==pb)a.remove();});
  [].slice.call(root.querySelectorAll('a[href="/customer-manager"]')).forEach(function(a){if(a!==cm)a.remove();});
}
/* v81 Design Studio header normalizer - END */
...
/* v85 platform tool row - BEGIN */
function v87InstallPlatformToolRow(){
  var root=document.getElementById(ROOT_ID);
  if(!root||root.querySelector(".ds-v87-platform-row"))return;
  var row=document.createElement("div");
  row.className="ds-v87-platform-row";
  row.setAttribute("style","max-width:1180px;margin:14px auto 18px;padding:16px 18px;border:1px solid rgba(11,31,51,.12);border-radius:22px;background:#fff;box-shadow:0 10px 26px rgba(11,31,51,.06);display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap;");
  row.innerHTML='<div><div style="font-size:12px;font-weight:900;letter-spacing:.12em;text-transform:uppercase;color:#356b9a;">Platform Navigation</div><div style="font-size:13px;color:rgba(11,31,51,.68);margin-top:4px;">Return to the Hub or continue to Page Setup.</div></div><div style="display:flex;gap:10px;flex-wrap:wrap;"><a href="/syncetc-landing-page" style="display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(11,31,51,.18);border-radius:999px;padding:10px 14px;background:#0b1f33;color:#fff;text-decoration:none;font-weight:900;font-size:13px;">← Hub</a><a href="/customer-manager" style="display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(11,31,51,.18);border-radius:999px;padding:10px 14px;background:#fff;color:#0b1f33;text-decoration:none;font-weight:900;font-size:13px;">Customer Manager</a><a href="/page-builder" style="display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(11,31,51,.18);border-radius:999px;padding:10px 14px;background:#fff;color:#0b1f33;text-decoration:none;font-weight:900;font-size:13px;">Page Setup →</a></div>';
  var previewLabel=[].slice.call(root.querySelectorAll("*")).find(function(el){return /CUSTOMER PREVIEW STARTS HERE/i.test(el.textContent||"");});
  if(previewLabel&&previewLabel.parentElement){
    previewLabel.parentElement.insertBefore(row,previewLabel);
  }else{
    root.appendChild(row);
  }
}
/* v85 platform tool row - END */


/* v85 Design Studio diagnostic - BEGIN */
window.SYNCETC_V87_TOOL_STATE=function(){
  var out={
    version:VERSION,
    headerCustomerManagerLinks:document.querySelectorAll('.ds-customer-manager-link[href="/customer-manager"]').length,
    headerPageBuilderLinks:document.querySelectorAll('.ds-pagebuilder-link[href="/page-builder"]').length,
    platformRows:document.querySelectorAll('.ds-v87-platform-row').length,
    authTokenPresent:!!getToken(),
    authEmail:state.authEmail||""
  };
  console.log("SYNCETC_V87_TOOL_STATE",out);
  return out;
};
/* v85 Design Studio diagnostic - END */

if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start);else start();setTimeout(v87NormalizeDesignStudioHeader,50);setTimeout(v87NormalizeDesignStudioHeader,300);setTimeout(v87InstallPlatformToolRow,80);setTimeout(v87InstallPlatformToolRow,350);
...
renderFrame=function(){
  ...
  setTimeout(function(){ensureVisibleDiagnosticPanel();bindPageSpecificSettingsControls();},0);
};
/* v36 post-render visible diagnostic hook - END */

})();

/* PAGE-DESIGN-STUDIO-v87.js - END */
