...
/* PAGE-DESIGN-STUDIO-v46.js | registry scope fix for Design Studio runtime | Generated: 2026-06-01 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v46";
...
var STYLE_ID="syncetc-design-studio-v46-style";
...
var SYNCETC_CUSTOMER_REGISTRY={
  "150th-aero":{
    ...
    legacy_customer_names:["150th Aero Flying Club","demo_flying_club"]
  },
  "test-customer":{
...
function normalizeCustomerKey(value){
  ...
  if(SYNCETC_CUSTOMER_REGISTRY[v])return v;
  var keys=Object.keys(SYNCETC_CUSTOMER_REGISTRY);
  for(var i=0;i<keys.length;i++){
    var row=SYNCETC_CUSTOMER_REGISTRY[keys[i]];
    if(row.customer_name===v || row.display_label===v || (row.legacy_customer_names||[]).indexOf(v)>=0)return keys[i];
  }
  return v;
}
...
function activeCustomerContext(){
  ...
  var raw=state.customer_key||state.customerKey||state.customer||state.customerName||"150th-aero";
