/* PAGE-DESIGN-STUDIO-v9.js | visible full-screen button and header cleanup | Generated: 2026-06-01 05:55:00 UTC */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v9";
...
var STYLE_ID="syncetc-design-studio-v9-style";
...
function bindFrame(){
  ...
  r.querySelectorAll('[data-ds-action]').forEach(function(btn){
    btn.addEventListener('click',function(){
      ...
      if(action==='full-preview'){state.fullPreview=true;state.sideOpen=false;renderFrame();updatePreview(false);return;}
      if(action==='exit-full'){state.fullPreview=false;renderFrame();updatePreview(false);return;}
