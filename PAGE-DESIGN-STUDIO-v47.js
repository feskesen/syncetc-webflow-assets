...
var SYNCETC_INFO_PAGE_DEFAULTS={
...
/* PAGE-DESIGN-STUDIO-v47.js | customer key normalization registry fix | Generated: 2026-06-01 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v47";
...
var STYLE_ID="syncetc-design-studio-v47-style";
...
function renderInfoPreviewForDesignStudio(){
  ...
  function pick(k, fallback){
    return esc(vals["info."+k]||vals[k]||SYNCETC_INFO_PAGE_DEFAULTS[k]||fallback||"");
  }
  return '<section class="aero-info-page" data-design-studio-preview-page="info" data-registry-page="info">'+
    '<div class="aero-info-shell">'+
      '<section class="aero-info-hero">'+
        '<div class="aero-info-eyebrow">'+pick("heroEyebrow","About & FAQs")+'</div>'+
        '<h1>'+pick("heroTitle","About 150th Aero Flying Club")+'</h1>'+
        '<p>'+pick("heroIntro","")+'</p>'+
        '<div class="aero-info-stats">'+
          '<div class="aero-info-stat"><strong>1960</strong><span>Founded by aviation-minded members.</span></div>'+
          '<div class="aero-info-stat"><strong>KMMU / KSMQ</strong><span>Primary operating airports.</span></div>'+
          '<div class="aero-info-stat"><strong>INFO</strong><span>Customer-specific page content.</span></div>'+
        '</div>'+
      '</section>'+
      '<main class="aero-info-main">'+
        '<div class="aero-info-column">'+
          '<section class="aero-section-card"><div class="aero-section-label">'+pick("sections.0.label","Our History")+'</div><h2>'+pick("sections.0.title","A long-running New Jersey flying club")+'</h2><p>'+pick("sections.0.body.0","")+'</p><p>'+pick("sections.0.body.1","")+'</p></section>'+
          '<section class="aero-section-card"><div class="aero-section-label">'+pick("sections.1.label","Membership")+'</div><h2>'+pick("sections.1.title","Shared aircraft, shared responsibility")+'</h2><p>'+pick("sections.1.body.0","")+'</p><p>'+pick("sections.1.body.1","")+'</p></section>'+
          '<section class="aero-section-card"><div class="aero-section-label">'+pick("boardLabel","Board & Officers")+'</div><h2>'+pick("boardTitle","Current club officers")+'</h2><p>'+pick("boardIntro","")+'</p></section>'+
        '</div>'+
        '<aside class="aero-info-column"><section class="aero-faq-panel"><div class="aero-faq-header"><div class="aero-section-label">'+pick("faqLabel","FAQs")+'</div><h2>'+pick("faqTitle","Frequently Asked Questions")+'</h2><p>'+pick("faqIntro","")+'</p></div><div class="aero-faq-list"><div class="aero-faq-item is-open"><button class="aero-faq-question" type="button"><span>Sample FAQ preview</span><span class="aero-faq-icon">+</span></button><div class="aero-faq-answer"><p>FAQ records remain page data; editable fields control the page copy.</p></div></div></div></section></aside>'+
      '</main>'+
...
function renderAssetsPreviewForDesignStudio(){
  if(typeof renderAircraftPreviewForDesignStudio==="function")return renderAircraftPreviewForDesignStudio();
  if(typeof renderAssetsPreview==="function")return renderAssetsPreview();
  if(typeof renderAircraftPreview==="function")return renderAircraftPreview();
  if(typeof renderActualAircraftPreview==="function")return renderActualAircraftPreview();

  var vals=livePageTextValues ? livePageTextValues() : {};
  function val(k,fallback){return esc(vals["aircraft."+k]||vals[k]||fallback||"");}
  return '<section class="aero-fleet-page" data-design-studio-preview-page="assets" data-registry-page="assets">'+
    '<div class="aero-fleet-shell">'+
      '<section class="aero-fleet-hero"><div class="aero-fleet-eyebrow">'+val("heroEyebrow","Aircraft Fleet")+'</div><h1>'+val("heroTitle","Our Aircraft")+'</h1><p>'+val("heroIntro","The customer asset page lists aircraft, vehicles, equipment, rooms, or other managed resources.")+'</p><div class="aero-fleet-stats"><div class="aero-fleet-stat"><strong>FOUR</strong><span>Club aircraft currently available to qualified members.</span></div><div class="aero-fleet-stat"><strong>KMMU / KSMQ</strong><span>Primary bases.</span></div><div class="aero-fleet-stat"><strong>C172</strong><span>Practical general aviation platform.</span></div></div></section>'+
      '<main class="aero-fleet-main"><section class="aero-fleet-intro-card"><div class="aero-section-label">'+val("introLabel","Fleet Overview")+'</div><h2>'+val("introTitle","Well-equipped aircraft for Club flying")+'</h2><p>'+val("introText","Each asset has its own profile, media, and operating details.")+'</p></section><section class="aero-aircraft-list"><div class="aero-empty-message">Asset records will render here. If this appears instead of aircraft cards, the full Assets preview renderer is not available in Design Studio.</div></section></main>'+
    '</div>'+
  '</section>';
}
