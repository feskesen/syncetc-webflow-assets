...
/* PAGE-DESIGN-STUDIO-v51.js | force apply real data bridge on render | Generated: 2026-06-01 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v51";
...
var STYLE_ID="syncetc-design-studio-v51-style";
...
function renderAssetsPreviewForDesignStudio(){
  ...
  var hasRecords=hasConnectedRecordData("assets");
  ...
  return '<section class="aero-fleet-page" data-design-studio-preview-page="assets" data-registry-page="assets">'+
    '<div class="aero-fleet-shell">'+
      '<section class="aero-fleet-hero"><div class="aero-fleet-eyebrow">'+val("heroEyebrow")+'</div><h1>'+val("heroTitle")+'</h1><p>'+val("heroIntro")+'</p></section>'+
      '<main class="aero-fleet-main"><section class="aero-fleet-intro-card"><div class="aero-section-label">'+val("introLabel")+'</div><h2>'+val("introTitle")+'</h2><p>'+val("introText")+'</p></section><section class="aero-aircraft-list"><div class="ds-data-contract-note">Asset cards are intentionally record-fed. They must come from customer asset records, not from fake preview data.</div></section></main>'+
    '</div>'+
  '</section>';
}
