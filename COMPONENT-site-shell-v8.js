...
(function () {
  ...
  function installDrawerStyles(){
    window.SyncEtc.Components.Utils.installStyle("COMPONENT-site-shell-v8-drawer-style",`
      .syncetc-admin-fab{position:fixed;right:18px;bottom:18px;z-index:99990;display:flex;gap:8px;align-items:center;border:1px solid rgba(18,54,90,.16);background:#12365a;color:#fff;border-radius:999px;padding:12px 15px;font-weight:950;font-size:13px;box-shadow:0 14px 34px rgba(12,38,64,.22);cursor:pointer}
      .syncetc-admin-fab small{font-size:10px;font-weight:900;opacity:.82;text-transform:uppercase;letter-spacing:.04em}
      ...
      .syncetc-drawer{position:fixed;right:0;top:0;height:100vh;width:min(440px,92vw);z-index:99992;background:#f8fbff;border-left:1px solid rgba(18,54,90,.14);box-shadow:-20px 0 46px rgba(12,38,64,.22);transform:translateX(102%);transition:transform .22s ease;display:flex;flex-direction:column}
      ...
      @media(max-width:720px){
        .syncetc-admin-fab{right:12px;bottom:12px}
...
/* COMPONENT-site-shell-v8.js - END */
