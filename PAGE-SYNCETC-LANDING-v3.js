/* PAGE-SYNCETC-LANDING-v3.js | SyncEtc Hub refined header layout | Generated: 2026-06-03 */
(function(){
  "use strict";

  var VERSION="PAGE-SYNCETC-LANDING-v3";
  var ROOT_ID="syncetc-webflow-mount";
  var STYLE_ID="syncetc-landing-v3-style";
  ...
  function renderToolHeader(){return '<section class="syncetc-tool-header"><div class="syncetc-tool-header-main"><div class="syncetc-tool-header-brandline"><img class="syncetc-tool-header-logo" src="'+esc(LOGO_URL)+'" alt="SyncEtc"><h1 class="syncetc-tool-header-title">Hub</h1></div><div class="syncetc-tool-header-eyebrow">SYNCETC COMPANY TOOL</div><p class="syncetc-tool-header-description">Company tools portal for customer setup, layout design, and page setup.</p></div><nav class="syncetc-tool-header-nav" aria-label="SyncEtc tools">'+toolHeaderButton("Hub","/syncetc-landing-page",true)+toolHeaderButton("Customer Manager","/customer-manager",false)+toolHeaderButton("Layout Designer","/design-studio",false)+toolHeaderButton("Page Setup","/page-builder",false)+'</nav></section>';}
  ...
  function installStyle(){if(document.getElementById(STYLE_ID))return;var css=document.createElement("style");css.id=STYLE_ID;css.textContent=[
    ...
    ".syncetc-tool-header-brandline{display:flex;align-items:center;gap:18px;flex-wrap:wrap;margin-bottom:10px}",
    ".syncetc-tool-header-logo{display:block;width:150px;max-width:42vw;height:auto}",
    ".syncetc-tool-header-title{font-size:38px;line-height:1;margin:0;letter-spacing:-.04em;color:#071633}",
    ...
    "@media(max-width:760px){.syncetc-tool-header{padding:22px;align-items:flex-start}.syncetc-tool-header-logo{width:128px}.syncetc-tool-header-title{font-size:32px}.syncetc-tool-header-nav{justify-content:flex-start}}"
  ...
  window.SYNCETC_LANDING_V3_STATE=function(){var out={version:VERSION,authed:isAuthed(),authEmail:state.authEmail,logo:LOGO_URL};console.log("SYNCETC_LANDING_V3_STATE",out);return out;};
  function start(){loadAuthSession();render();}
  if(document.readyState==="loading")document.addEventListener("DOMContentLoaded",start);else start();
})();

/* PAGE-SYNCETC-LANDING-v3.js - END */
