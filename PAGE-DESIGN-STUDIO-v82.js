...
/* PAGE-DESIGN-STUDIO-v82.js | Design Studio 2.1 page-builder header button fix | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v82";
...
var STYLE_ID="syncetc-design-studio-v82-style";
...
function renderFrame(){
  ...
  mount.innerHTML='<div id="'+ROOT_ID+'" class="'+(state.loading?'ds-skeleton ':'')+(state.fullPreview?'ds-full-preview ':'')+(state.sideOpen?'ds-page-text-mode ':'')+(diag.ok?'':'ds-style-diagnostic-missing')+'">'+
    ...
    '<div class="ds-shell">'+
      '<div class="ds-hero-top"><div><span class="ds-kicker">SyncEtc Company Tool</span><div class="ds-title-row"><div class="ds-title-copy"><h1>Design Studio</h1><div class="ds-sample-preview-note">Design Studio 2.1: visual layout and design-profile editor. Page creation moves to Page Builder.</div></div><a class="ds-pagebuilder-link" href="/page-builder">Page Builder →</a></div></div><div class="ds-version">'+esc(VERSION)+'</div></div>'+
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V82){
    window.__SYNCETC_DS_ESC_CLOSE_V82=true;
...
window.SYNCETC_V82_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V82,
  ...
  console.log('SYNCETC_V82_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V82_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V82_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V82_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V82_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V82_SCOPE_STATE",out);
  return out;
};
...
window.SYNCETC_V82_STUDIO_STATE=function(){
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V82_STUDIO_STATE",out);
  return out;
};
...
function v82NormalizeDesignStudioHeader(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;

  var headings=[].slice.call(root.querySelectorAll("h1,h2,.ds-title,.ds-hero-title,.ds-brand-title"));
  var heading=headings.find(function(el){return /Design Studio/i.test(el.textContent||"");});
  if(!heading)return;

  var header=heading.parentElement||root;
  header.classList.add("ds-v82-title-pad");

  [].slice.call(root.querySelectorAll('a[href="/page-builder"],a[href*="/page-builder"]')).forEach(function(a){
    if(!a.classList.contains("ds-v82-pagebuilder-button"))a.remove();
  });

  var btn=root.querySelector(".ds-v82-pagebuilder-button");
  if(!btn){
    btn=document.createElement("a");
    btn.className="ds-v82-pagebuilder-button";
    btn.href="/page-builder";
    btn.textContent="Page Builder →";
    header.appendChild(btn);
  }
  btn.href="/page-builder";
  btn.textContent="Page Builder →";

  var loose=[].slice.call(root.querySelectorAll("a")).filter(function(a){
    return /Page Builder/i.test(a.textContent||"") && !a.classList.contains("ds-v82-pagebuilder-button");
  });
  loose.forEach(function(a){a.remove();});
}
...
/* v82 Design Studio header diagnostic - BEGIN */
window.SYNCETC_V82_HEADER_STATE=function(){
  var out={
    version:VERSION,
    finalButtonCount:document.querySelectorAll('.ds-v82-pagebuilder-button[href="/page-builder"]').length,
    loosePageBuilderLinks:[].slice.call(document.querySelectorAll('a')).filter(function(a){return /Page Builder/i.test(a.textContent||"")&&!a.classList.contains("ds-v82-pagebuilder-button");}).length
  };
  console.log("SYNCETC_V82_HEADER_STATE",out);
  return out;
};
/* v82 Design Studio header diagnostic - END */

if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start);else start();setTimeout(v82NormalizeDesignStudioHeader,50);setTimeout(v82NormalizeDesignStudioHeader,300);setTimeout(v82NormalizeDesignStudioHeader,900);
