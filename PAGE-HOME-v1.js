...
(function () {
  ...
  const VERSION="PAGE-HOME-v1";
  const FILE_NAME = "PAGE-HOME-v1.js";
  ...
  function renderComponentPageBody(base) {
    ...
    if ("home" === "home") return renderHome(base);
    if ("home" === "info") return renderInfoPage(base);
    if ("home" === "aircraft") return renderAircraftPage(base);
