...
/* PAGE-DESIGN-STUDIO-v86.js | Design Studio platform tool hub visibility patch | Generated: 2026-06-03 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v86";
...
var STYLE_ID="syncetc-design-studio-v86-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V86){
    window.__SYNCETC_DS_ESC_CLOSE_V86=true;
...
window.SYNCETC_V86_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V86,
  ...
  console.log('SYNCETC_V86_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V86_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V86_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V86_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V86_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V86_SCOPE_STATE",out);
  return out;
};
...
window.SYNCETC_V86_STUDIO_STATE=function(){
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V86_STUDIO_STATE",out);
  return out;
};
...
function v86NormalizeDesignStudioHeader(){
  ...
  var cm=ensureButton("ds-customer-manager-link ds-v86-tool-pill","/customer-manager","Customer Manager");
  var pb=ensureButton("ds-pagebuilder-link ds-v86-tool-pill","/page-builder","Page Builder →");
...
function v86InstallPlatformToolRow(){
  var root=document.getElementById(ROOT_ID);
  if(!root||root.querySelector(".ds-v86-platform-row"))return;
  var row=document.createElement("div");
  row.className="ds-v86-platform-row";
  ...
  row.innerHTML='<div><div style="font-size:12px;font-weight:900;letter-spacing:.12em;text-transform:uppercase;color:#356b9a;">Platform Workflow</div><div style="font-size:13px;color:rgba(11,31,51,.68);margin-top:4px;">Start with Customer Manager, then use Design Studio and Page Builder.</div></div><div style="display:flex;gap:10px;flex-wrap:wrap;"><a href="/customer-manager" style="display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(11,31,51,.18);border-radius:999px;padding:10px 14px;background:#0b1f33;color:#fff;text-decoration:none;font-weight:900;font-size:13px;">Customer Manager</a><a href="/page-builder" style="display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(11,31,51,.18);border-radius:999px;padding:10px 14px;background:#fff;color:#0b1f33;text-decoration:none;font-weight:900;font-size:13px;">Page Builder →</a></div>';
...
window.SYNCETC_V86_TOOL_STATE=function(){
  var out={
    version:VERSION,
    ...
    platformRows:document.querySelectorAll('.ds-v86-platform-row').length,
    authTokenPresent:!!getToken(),
    authEmail:state.authEmail||""
  };
  console.log("SYNCETC_V86_TOOL_STATE",out);
  return out;
};
/* v85 Design Studio diagnostic - END */

if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start);else start();setTimeout(v86NormalizeDesignStudioHeader,50);setTimeout(v86NormalizeDesignStudioHeader,300);setTimeout(v86InstallPlatformToolRow,80);setTimeout(v86InstallPlatformToolRow,350);
