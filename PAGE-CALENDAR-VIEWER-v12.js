/* PAGE-CALENDAR-VIEWER-v12.js - BEGIN */
(function(){
"use strict";
...
function ensureComponents(){var base=componentBaseUrl();return COMPONENT_FILES.reduce(function(p,file){return p.then(function(){return loadScriptOnce(base + file + "?v=calendar-viewer-sequenced-v12");});},Promise.resolve());}
var VERSION="PAGE-CALENDAR-VIEWER-v12",EDGE_READ_URL="https://ocdaohkiwonjmirqkjww.supabase.co/functions/v1/syncetc-calendar-viewer-read";
...
/* PAGE-CALENDAR-VIEWER-v12.js - END */
