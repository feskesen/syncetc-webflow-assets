...
/* PAGE-DESIGN-STUDIO-v88.js | Shared SyncEtc tool header | Generated: 2026-06-03 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v88";
...
var STYLE_ID="syncetc-design-studio-v88-style";
...
function bindFrame(){
  ...
  if(!window.__SYNCETC_DS_ESC_CLOSE_V88){
    window.__SYNCETC_DS_ESC_CLOSE_V88=true;
...
window.SYNCETC_V88_CLOSE_WIRING_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    escCloseInstalled:!!window.__SYNCETC_DS_ESC_CLOSE_V88,
  ...
  console.log('SYNCETC_V88_CLOSE_WIRING_STATE',out);
  return out;
};
...
window.SYNCETC_V88_SAVE_STATE=function(){
  var values=v77SaveValuesFromAppliedState();
  var target=v77SaveTargetState(values);
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V88_SAVE_STATE",out);
  return out;
};
...
window.SYNCETC_V88_SCOPE_STATE=function(){
  var ctx=activeCustomerContext&&activeCustomerContext();
  var reg=activePageRegistry&&activePageRegistry();
  var out={
    version:VERSION,
    ...
    closeButtonCount:document.querySelectorAll('[data-ds-action="side-close"]').length,
    saveDiagnosticExists:typeof window.SYNCETC_V88_SAVE_STATE==="function"
  };
  console.log("SYNCETC_V88_SCOPE_STATE",out);
  return out;
};
...
window.SYNCETC_V88_STUDIO_STATE=function(){
  var out={
    version:VERSION,
  ...
  console.log("SYNCETC_V88_STUDIO_STATE",out);
  return out;
};
...
function v88NormalizeDesignStudioHeader(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;
  var existing=root.querySelector(".syncetc-tool-header");
  if(existing)return;
  var headerHtml=renderToolHeader("layout-designer","Layout Designer","Customer-wide visual layout and design-profile editor. Page creation moves to Page Setup.","SYNCETC COMPANY TOOL");
  var wrap=document.createElement("div");
...
function v88InstallPlatformToolRow(){
  var root=document.getElementById(ROOT_ID);
  if(!root)return;
  v88NormalizeDesignStudioHeader();
}
/* v85 platform tool row - END */


/* v85 Design Studio diagnostic - BEGIN */
window.SYNCETC_V88_TOOL_STATE=function(){
  var out={
    version:VERSION,
    ...
    platformRows:document.querySelectorAll('.ds-v88-platform-row').length,
    authTokenPresent:!!getToken(),
    authEmail:state.authEmail||""
  };
  console.log("SYNCETC_V88_TOOL_STATE",out);
  return out;
};
/* v85 Design Studio diagnostic - END */

if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start);else start();setTimeout(v88NormalizeDesignStudioHeader,50);setTimeout(v88NormalizeDesignStudioHeader,300);setTimeout(v88InstallPlatformToolRow,80);setTimeout(v88InstallPlatformToolRow,350);
