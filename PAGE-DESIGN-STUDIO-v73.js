...
/* PAGE-DESIGN-STUDIO-v73.js | close button no guard dependency | Generated: 2026-06-02 */
(function(){
"use strict";

var VERSION="PAGE-DESIGN-STUDIO-v73";
...
var STYLE_ID="syncetc-design-studio-v73-style";
...
/* v73 local close behavior - BEGIN */
function v73HasPageSpecificUnsavedWork(){
  return !!(state.sideDirty||state.sideAppliedDirty);
}

function v73CloseSideDrawer(){
  if(v73HasPageSpecificUnsavedWork()){
...
if(!window.__SYNCETC_DS_BEFOREUNLOAD_V73){
  window.__SYNCETC_DS_BEFOREUNLOAD_V73=true;
  window.addEventListener("beforeunload",function(e){
    if(!v73HasPageSpecificUnsavedWork())return;
    e.preventDefault();
    e.returnValue="";
    return "";
  });
}
/* v73 local close behavior - END */
...
/* v73 removed legacy legacyDiscardUpper */
...
function bindFrame(){
  ...
  r.querySelectorAll('[data-ds-action]').forEach(function(btn){
    btn.addEventListener('click',function(){
      ...
      if(action==='side-close'){v73CloseSideDrawer();return;}
      if(action==='apply-page-text'){applyPageText();return;}
      if(action==='save-page-text'){savePageText();return;}
      if(action==='discard-page-text'){v73CloseSideDrawer();return;}
...
/* v73 removed old discard capture fallback */
...
/* v73 removed install unsaved guards dependency */

/* v73 close capture fallback - BEGIN */
if(!window.__SYNCETC_DS_CLOSE_CAPTURE_V73){
  window.__SYNCETC_DS_CLOSE_CAPTURE_V73=true;
  document.addEventListener("click",function(e){
...
/* v73 close capture fallback - END */


/* v73 close diagnostic - BEGIN */
window.SYNCETC_V73_CLOSE_STATE=function(){
  var out={
    version:VERSION,
    sideOpen:state.sideOpen,
    sideDirty:state.sideDirty,
    sideAppliedDirty:state.sideAppliedDirty,
    hasUnsaved:v73HasPageSpecificUnsavedWork(),
    closeCaptureInstalled:!!window.__SYNCETC_DS_CLOSE_CAPTURE_V73,
    beforeUnloadInstalled:!!window.__SYNCETC_DS_BEFOREUNLOAD_V73
  };
  console.log("SYNCETC_V73_CLOSE_STATE",out);
  return out;
};
/* v73 close diagnostic - END */

/* PAGE-DESIGN-STUDIO-v73.js - END */
